...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       ...
       b:	ff 35 6c 5b 00 00    	pushl  0x5b6c
      11:	e8 5c 38 00 00       	call   3872 <printf>
  ...
  printf(stdout, "iput test ok\n");
      ...
      6d:	ff 35 6c 5b 00 00    	pushl  0x5b6c
      73:	e8 fa 37 00 00       	call   3872 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
      ...
      85:	ff 35 6c 5b 00 00    	pushl  0x5b6c
      8b:	e8 e2 37 00 00       	call   3872 <printf>
    exit();
      90:	e8 8b 36 00 00       	call   3720 <exit>
    printf(stdout, "chdir iputdir failed\n");
      95:	83 ec 08             	sub    $0x8,%esp
      98:	68 3a 3b 00 00       	push   $0x3b3a
      9d:	ff 35 6c 5b 00 00    	pushl  0x5b6c
      a3:	e8 ca 37 00 00       	call   3872 <printf>
    exit();
      a8:	e8 73 36 00 00       	call   3720 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
      ad:	83 ec 08             	sub    $0x8,%esp
      b0:	68 5b 3b 00 00       	push   $0x3b5b
      b5:	ff 35 6c 5b 00 00    	pushl  0x5b6c
      bb:	e8 b2 37 00 00       	call   3872 <printf>
    exit();
      c0:	e8 5b 36 00 00       	call   3720 <exit>
    printf(stdout, "chdir / failed\n");
      c5:	83 ec 08             	sub    $0x8,%esp
      c8:	68 77 3b 00 00       	push   $0x3b77
      cd:	ff 35 6c 5b 00 00    	pushl  0x5b6c
      d3:	e8 9a 37 00 00       	call   3872 <printf>
    exit();
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      ...
      e8:	ff 35 6c 5b 00 00    	pushl  0x5b6c
      ee:	e8 7f 37 00 00       	call   3872 <printf>
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     10a:	68 53 3b 00 00       	push   $0x3b53
    ...
    if(chdir("iputdir") < 0){
     ...
     11e:	68 53 3b 00 00       	push   $0x3b53
    ...
    if(unlink("../iputdir") < 0){
     ...
     132:	68 50 3b 00 00       	push   $0x3b50
    ...
    printf(stdout, "fork failed\n");
     ...
     14b:	68 6d 4a 00 00       	push   $0x4a6d
     150:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     156:	e8 17 37 00 00       	call   3872 <printf>
    exit();
     15b:	e8 c0 35 00 00       	call   3720 <exit>
      printf(stdout, "mkdir failed\n");
     160:	83 ec 08             	sub    $0x8,%esp
     163:	68 2c 3b 00 00       	push   $0x3b2c
     168:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     16e:	e8 ff 36 00 00       	call   3872 <printf>
      exit();
     173:	e8 a8 35 00 00       	call   3720 <exit>
      printf(stdout, "child chdir failed\n");
     178:	83 ec 08             	sub    $0x8,%esp
     17b:	68 96 3b 00 00       	push   $0x3b96
     180:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     186:	e8 e7 36 00 00       	call   3872 <printf>
      exit();
     18b:	e8 90 35 00 00       	call   3720 <exit>
      printf(stdout, "unlink ../iputdir failed\n");
     190:	83 ec 08             	sub    $0x8,%esp
     193:	68 5b 3b 00 00       	push   $0x3b5b
     198:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     19e:	e8 cf 36 00 00       	call   3872 <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     1b0:	68 aa 3b 00 00       	push   $0x3baa
     1b5:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     1bb:	e8 b2 36 00 00       	call   3872 <printf>
}
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1cb:	68 bc 3b 00 00       	push   $0x3bbc
     1d0:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     1d6:	e8 97 36 00 00       	call   3872 <printf>
  if(mkdir("oidir") < 0){
     1db:	c7 04 24 cb 3b 00 00 	movl   $0x3bcb,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     1fe:	6a 02                	push   $0x2
     200:	68 cb 3b 00 00       	push   $0x3bcb
    ...
    if(fd >= 0){
     ...
     214:	68 50 4b 00 00       	push   $0x4b50
     219:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     21f:	e8 4e 36 00 00       	call   3872 <printf>
      exit();
     224:	e8 f7 34 00 00       	call   3720 <exit>
    printf(stdout, "mkdir oidir failed\n");
     229:	83 ec 08             	sub    $0x8,%esp
     22c:	68 d1 3b 00 00       	push   $0x3bd1
     231:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     237:	e8 36 36 00 00       	call   3872 <printf>
    exit();
     23c:	e8 df 34 00 00       	call   3720 <exit>
    printf(stdout, "fork failed\n");
     241:	83 ec 08             	sub    $0x8,%esp
     244:	68 6d 4a 00 00       	push   $0x4a6d
     249:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     24f:	e8 1e 36 00 00       	call   3872 <printf>
    exit();
  ...
  if(unlink("oidir") != 0){
     268:	c7 04 24 cb 3b 00 00 	movl   $0x3bcb,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     ...
     283:	68 f4 3b 00 00       	push   $0x3bf4
     288:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     28e:	e8 df 35 00 00       	call   3872 <printf>
}
    ...
    printf(stdout, "unlink failed\n");
     ...
     29b:	68 e5 3b 00 00       	push   $0x3be5
     2a0:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     2a6:	e8 c7 35 00 00       	call   3872 <printf>
    exit();
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2b6:	68 06 3c 00 00       	push   $0x3c06
     2bb:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     2c1:	e8 ac 35 00 00       	call   3872 <printf>
  fd = open("echo", 0);
     2c6:	83 c4 08             	add    $0x8,%esp
     2c9:	6a 00                	push   $0x0
     2cb:	68 11 3c 00 00       	push   $0x3c11
  ...
  fd = open("doesnotexist", 0);
     ...
     2e8:	6a 00                	push   $0x0
     2ea:	68 29 3c 00 00       	push   $0x3c29
  ...
  printf(stdout, "open test ok\n");
     ...
     2fe:	68 54 3c 00 00       	push   $0x3c54
     303:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     309:	e8 64 35 00 00       	call   3872 <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     ...
     316:	68 16 3c 00 00       	push   $0x3c16
     31b:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     321:	e8 4c 35 00 00       	call   3872 <printf>
    exit();
     326:	e8 f5 33 00 00       	call   3720 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     32b:	83 ec 08             	sub    $0x8,%esp
     32e:	68 36 3c 00 00       	push   $0x3c36
     333:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     339:	e8 34 35 00 00       	call   3872 <printf>
    exit();
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     34b:	68 62 3c 00 00       	push   $0x3c62
     350:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     356:	e8 17 35 00 00       	call   3872 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     35b:	83 c4 08             	add    $0x8,%esp
     35e:	68 02 02 00 00       	push   $0x202
     363:	68 73 3c 00 00       	push   $0x3c73
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     379:	68 79 3c 00 00       	push   $0x3c79
     37e:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     384:	e8 e9 34 00 00       	call   3872 <printf>
  } else {
  ...
  for(i = 0; i < 100; i++){
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     399:	6a 0a                	push   $0xa
     39b:	68 b0 3c 00 00       	push   $0x3cb0
     3a0:	56                   	push   %esi
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     3b1:	6a 0a                	push   $0xa
     3b3:	68 bb 3c 00 00       	push   $0x3cbb
     3b8:	56                   	push   %esi
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     3ce:	68 94 3c 00 00       	push   $0x3c94
     3d3:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     3d9:	e8 94 34 00 00       	call   3872 <printf>
    exit();
     3de:	e8 3d 33 00 00       	call   3720 <exit>
      printf(stdout, "error: write aa %d new file failed\n", i);
     3e3:	83 ec 04             	sub    $0x4,%esp
     3e6:	53                   	push   %ebx
     3e7:	68 74 4b 00 00       	push   $0x4b74
     3ec:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     3f2:	e8 7b 34 00 00       	call   3872 <printf>
      exit();
     3f7:	e8 24 33 00 00       	call   3720 <exit>
      printf(stdout, "error: write bb %d new file failed\n", i);
     3fc:	83 ec 04             	sub    $0x4,%esp
     3ff:	53                   	push   %ebx
     400:	68 98 4b 00 00       	push   $0x4b98
     405:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     40b:	e8 62 34 00 00       	call   3872 <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     ...
     418:	68 c6 3c 00 00       	push   $0x3cc6
     41d:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     423:	e8 4a 34 00 00       	call   3872 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     433:	6a 00                	push   $0x0
     435:	68 73 3c 00 00       	push   $0x3c73
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     44b:	68 d1 3c 00 00       	push   $0x3cd1
     450:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     456:	e8 17 34 00 00       	call   3872 <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     47b:	68 05 3d 00 00       	push   $0x3d05
     480:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     486:	e8 e7 33 00 00       	call   3872 <printf>
  } else {
  ...
  if(unlink("small") < 0){
     493:	c7 04 24 73 3c 00 00 	movl   $0x3c73,(%esp)
  ...
  printf(stdout, "small file test ok\n");
     ...
     4a9:	68 2d 3d 00 00       	push   $0x3d2d
     4ae:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     4b4:	e8 b9 33 00 00       	call   3872 <printf>
}
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     4c6:	68 ea 3c 00 00       	push   $0x3cea
     4cb:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     4d1:	e8 9c 33 00 00       	call   3872 <printf>
    exit();
     4d6:	e8 45 32 00 00       	call   3720 <exit>
    printf(stdout, "read failed\n");
     4db:	83 ec 08             	sub    $0x8,%esp
     4de:	68 31 40 00 00       	push   $0x4031
     4e3:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     4e9:	e8 84 33 00 00       	call   3872 <printf>
    exit();
     4ee:	e8 2d 32 00 00       	call   3720 <exit>
    printf(stdout, "unlink small failed\n");
     4f3:	83 ec 08             	sub    $0x8,%esp
     4f6:	68 18 3d 00 00       	push   $0x3d18
     4fb:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     501:	e8 6c 33 00 00       	call   3872 <printf>
    exit();
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     513:	68 41 3d 00 00       	push   $0x3d41
     518:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     51e:	e8 4f 33 00 00       	call   3872 <printf>

  fd = open("big", O_CREATE|O_RDWR);
     523:	83 c4 08             	add    $0x8,%esp
     526:	68 02 02 00 00       	push   $0x202
     52b:	68 bb 3d 00 00       	push   $0x3dbb
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     576:	68 51 3d 00 00       	push   $0x3d51
     57b:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     581:	e8 ec 32 00 00       	call   3872 <printf>
    exit();
     586:	e8 95 31 00 00       	call   3720 <exit>
      printf(stdout, "error: write big file failed\n", i);
     58b:	83 ec 04             	sub    $0x4,%esp
     58e:	53                   	push   %ebx
     58f:	68 6b 3d 00 00       	push   $0x3d6b
     594:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     59a:	e8 d3 32 00 00       	call   3872 <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     5b0:	6a 00                	push   $0x0
     5b2:	68 bb 3d 00 00       	push   $0x3dbb
  ...
  for(;;){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     604:	68 89 3d 00 00       	push   $0x3d89
     609:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     60f:	e8 5e 32 00 00       	call   3872 <printf>
    exit();
  ...
  if(unlink("big") < 0){
     62a:	c7 04 24 bb 3d 00 00 	movl   $0x3dbb,(%esp)
  ...
  printf(stdout, "big files ok\n");
     ...
     640:	68 e2 3d 00 00       	push   $0x3de2
     645:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     64b:	e8 22 32 00 00       	call   3872 <printf>
}
     ...
     65d:	53                   	push   %ebx
     65e:	68 a2 3d 00 00       	push   $0x3da2
     663:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     669:	e8 04 32 00 00       	call   3872 <printf>
        exit();
     66e:	e8 ad 30 00 00       	call   3720 <exit>
      printf(stdout, "read failed %d\n", i);
     673:	83 ec 04             	sub    $0x4,%esp
     676:	50                   	push   %eax
     677:	68 bf 3d 00 00       	push   $0x3dbf
     67c:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     682:	e8 eb 31 00 00       	call   3872 <printf>
      exit();
     687:	e8 94 30 00 00       	call   3720 <exit>
      printf(stdout, "read content of block %d is %d\n",
     68c:	50                   	push   %eax
     68d:	53                   	push   %ebx
     68e:	68 bc 4b 00 00       	push   $0x4bbc
     693:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     699:	e8 d4 31 00 00       	call   3872 <printf>
      exit();
     69e:	e8 7d 30 00 00       	call   3720 <exit>
    printf(stdout, "unlink big failed\n");
     6a3:	83 ec 08             	sub    $0x8,%esp
     6a6:	68 cf 3d 00 00       	push   $0x3dcf
     6ab:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     6b1:	e8 bc 31 00 00       	call   3872 <printf>
    exit();
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     6c2:	68 dc 4b 00 00       	push   $0x4bdc
     6c7:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     6cd:	e8 a0 31 00 00       	call   3872 <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     74f:	68 04 4c 00 00       	push   $0x4c04
     754:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     75a:	e8 13 31 00 00       	call   3872 <printf>
}
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     76d:	68 f0 3d 00 00       	push   $0x3df0
     772:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     778:	e8 f5 30 00 00       	call   3872 <printf>

  if(mkdir("dir0") < 0){
     77d:	c7 04 24 fc 3d 00 00 	movl   $0x3dfc,(%esp)
  ...
  if(chdir("dir0") < 0){
     ...
     793:	68 fc 3d 00 00       	push   $0x3dfc
  ...
  if(chdir("..") < 0){
     ...
     7a7:	68 a1 43 00 00       	push   $0x43a1
  ...
  if(unlink("dir0") < 0){
     ...
     7bb:	68 fc 3d 00 00       	push   $0x3dfc
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     7cf:	68 39 3e 00 00       	push   $0x3e39
     7d4:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     7da:	e8 93 30 00 00       	call   3872 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     ...
     7e7:	68 2c 3b 00 00       	push   $0x3b2c
     7ec:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     7f2:	e8 7b 30 00 00       	call   3872 <printf>
    exit();
     7f7:	e8 24 2f 00 00       	call   3720 <exit>
    printf(stdout, "chdir dir0 failed\n");
     7fc:	83 ec 08             	sub    $0x8,%esp
     7ff:	68 01 3e 00 00       	push   $0x3e01
     804:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     80a:	e8 63 30 00 00       	call   3872 <printf>
    exit();
     80f:	e8 0c 2f 00 00       	call   3720 <exit>
    printf(stdout, "chdir .. failed\n");
     814:	83 ec 08             	sub    $0x8,%esp
     817:	68 14 3e 00 00       	push   $0x3e14
     81c:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     822:	e8 4b 30 00 00       	call   3872 <printf>
    exit();
     827:	e8 f4 2e 00 00       	call   3720 <exit>
    printf(stdout, "unlink dir0 failed\n");
     82c:	83 ec 08             	sub    $0x8,%esp
     82f:	68 25 3e 00 00       	push   $0x3e25
     834:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     83a:	e8 33 30 00 00       	call   3872 <printf>
    exit();
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     84a:	68 48 3e 00 00       	push   $0x3e48
     84f:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     855:	e8 18 30 00 00       	call   3872 <printf>
  if(exec("echo", echoargv) < 0){
     85a:	83 c4 08             	add    $0x8,%esp
     85d:	68 70 5b 00 00       	push   $0x5b70
     862:	68 11 3c 00 00       	push   $0x3c11
    ...
    printf(stdout, "exec echo failed\n");
     ...
     878:	68 53 3e 00 00       	push   $0x3e53
     87d:	ff 35 6c 5b 00 00    	pushl  0x5b6c
     883:	e8 ea 2f 00 00       	call   3872 <printf>
    exit();
...
pipe1(void)
{
  ...
  seq = 0;
    ...
    printf(1, "pipe() failed\n");
     ...
     91d:	68 65 3e 00 00       	push   $0x3e65
     922:	6a 01                	push   $0x1
     924:	e8 49 2f 00 00       	call   3872 <printf>
    exit();
  ...
  seq = 0;
    ...
    for(n = 0; n < 5; n++){
     ...
     983:	68 74 3e 00 00       	push   $0x3e74
     988:	6a 01                	push   $0x1
     98a:	e8 e3 2e 00 00       	call   3872 <printf>
        exit();
    ...
    exit();
     ...
     99c:	68 82 3e 00 00       	push   $0x3e82
     9a1:	6a 01                	push   $0x1
     9a3:	e8 ca 2e 00 00       	call   3872 <printf>
          return;
  ...
  printf(1, "pipe1 ok\n");
     ...
     9f1:	68 a7 3e 00 00       	push   $0x3ea7
     9f6:	6a 01                	push   $0x1
     9f8:	e8 75 2e 00 00       	call   3872 <printf>
     9fd:	83 c4 10             	add    $0x10,%esp
     a00:	eb a9                	jmp    9ab <pipe1+0x11e>
      printf(1, "pipe1 oops 3 total %d\n", total);
     a02:	83 ec 04             	sub    $0x4,%esp
     a05:	ff 75 d0             	pushl  -0x30(%ebp)
     a08:	68 90 3e 00 00       	push   $0x3e90
     a0d:	6a 01                	push   $0x1
     a0f:	e8 5e 2e 00 00       	call   3872 <printf>
      exit();
     a14:	e8 07 2d 00 00       	call   3720 <exit>
    printf(1, "fork() failed\n");
     a19:	83 ec 08             	sub    $0x8,%esp
     a1c:	68 b1 3e 00 00       	push   $0x3eb1
     a21:	6a 01                	push   $0x1
     a23:	e8 4a 2e 00 00       	call   3872 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     a36:	68 c0 3e 00 00       	push   $0x3ec0
     a3b:	6a 01                	push   $0x1
     a3d:	e8 30 2e 00 00       	call   3872 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     a87:	6a 01                	push   $0x1
     a89:	68 85 44 00 00       	push   $0x4485
     ...
     aa1:	68 ca 3e 00 00       	push   $0x3eca
     aa6:	6a 01                	push   $0x1
     aa8:	e8 c5 2d 00 00       	call   3872 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     ...
     aeb:	68 de 3e 00 00       	push   $0x3ede
     af0:	6a 01                	push   $0x1
     af2:	e8 7b 2d 00 00       	call   3872 <printf>
    return;
  ...
  printf(1, "kill... ");
     ...
     b10:	68 f1 3e 00 00       	push   $0x3ef1
     b15:	6a 01                	push   $0x1
     b17:	e8 56 2d 00 00       	call   3872 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     ...
     b37:	68 fa 3e 00 00       	push   $0x3efa
     b3c:	6a 01                	push   $0x1
     b3e:	e8 2f 2d 00 00       	call   3872 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ...
     b55:	68 03 3f 00 00       	push   $0x3f03
     b5a:	6a 01                	push   $0x1
     b5c:	e8 11 2d 00 00       	call   3872 <printf>
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
     ...
     b95:	68 6d 4a 00 00       	push   $0x4a6d
     b9a:	6a 01                	push   $0x1
     b9c:	e8 d1 2c 00 00       	call   3872 <printf>
      return;
  ...
  printf(1, "exitwait ok\n");
     ...
     bae:	68 0f 3f 00 00       	push   $0x3f0f
     bb3:	6a 01                	push   $0x1
     bb5:	e8 b8 2c 00 00       	call   3872 <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     bc7:	68 1f 3f 00 00       	push   $0x3f1f
     bcc:	6a 01                	push   $0x1
     bce:	e8 9f 2c 00 00       	call   3872 <printf>
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     be1:	68 2c 3f 00 00       	push   $0x3f2c
     be6:	6a 01                	push   $0x1
     be8:	e8 85 2c 00 00       	call   3872 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     c17:	e8 7f 2e 00 00       	call   3a9b <malloc>
    ...
    while(m1){
     ...
     c2a:	53                   	push   %ebx
     c2b:	e8 ab 2d 00 00       	call   39db <free>
      m1 = m2;
    ...
    m1 = malloc(1024*20);
     ...
     c41:	e8 55 2e 00 00       	call   3a9b <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     c50:	50                   	push   %eax
     c51:	e8 85 2d 00 00       	call   39db <free>
    printf(1, "mem ok\n");
     c56:	83 c4 08             	add    $0x8,%esp
     c59:	68 50 3f 00 00       	push   $0x3f50
     c5e:	6a 01                	push   $0x1
     c60:	e8 0d 2c 00 00       	call   3872 <printf>
    exit();
     c65:	e8 b6 2a 00 00       	call   3720 <exit>
      printf(1, "couldn't allocate mem?!!\n");
     c6a:	83 ec 08             	sub    $0x8,%esp
     c6d:	68 36 3f 00 00       	push   $0x3f36
     c72:	6a 01                	push   $0x1
     c74:	e8 f9 2b 00 00       	call   3872 <printf>
      kill(ppid);
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     c9c:	68 58 3f 00 00       	push   $0x3f58
     ca1:	6a 01                	push   $0x1
     ca3:	e8 ca 2b 00 00       	call   3872 <printf>

  unlink("sharedfd");
     ca8:	c7 04 24 67 3f 00 00 	movl   $0x3f67,(%esp)
     caf:	e8 bc 2a 00 00       	call   3770 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     cb4:	83 c4 08             	add    $0x8,%esp
     cb7:	68 02 02 00 00       	push   $0x202
     cbc:	68 67 3f 00 00       	push   $0x3f67
  ...
  for(i = 0; i < 1000; i++){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     d1d:	68 2c 4c 00 00       	push   $0x4c2c
     d22:	6a 01                	push   $0x1
     d24:	e8 49 2b 00 00       	call   3872 <printf>
    return;
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
     ...
     d3b:	68 58 4c 00 00       	push   $0x4c58
     d40:	6a 01                	push   $0x1
     d42:	e8 2b 2b 00 00       	call   3872 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     d5f:	6a 00                	push   $0x0
     d61:	68 67 3f 00 00       	push   $0x3f67
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     da3:	68 78 4c 00 00       	push   $0x4c78
     da8:	6a 01                	push   $0x1
     daa:	e8 c3 2a 00 00       	call   3872 <printf>
    return;
  ...
  unlink("sharedfd");
     dde:	c7 04 24 67 3f 00 00 	movl   $0x3f67,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     e06:	68 70 3f 00 00       	push   $0x3f70
     e0b:	6a 01                	push   $0x1
     e0d:	e8 60 2a 00 00       	call   3872 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     e1d:	56                   	push   %esi
     e1e:	53                   	push   %ebx
     e1f:	68 7d 3f 00 00       	push   $0x3f7d
     e24:	6a 01                	push   $0x1
     e26:	e8 47 2a 00 00       	call   3872 <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
     e39:	c7 45 d8 92 3f 00 00 	movl   $0x3f92,-0x28(%ebp)
     e40:	c7 45 dc db 40 00 00 	movl   $0x40db,-0x24(%ebp)
     e47:	c7 45 e0 df 40 00 00 	movl   $0x40df,-0x20(%ebp)
     e4e:	c7 45 e4 95 3f 00 00 	movl   $0x3f95,-0x1c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
     e55:	68 98 3f 00 00       	push   $0x3f98
     e5a:	6a 01                	push   $0x1
     e5c:	e8 11 2a 00 00       	call   3872 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
     ...
     e97:	68 6d 4a 00 00       	push   $0x4a6d
     e9c:	6a 01                	push   $0x1
     e9e:	e8 cf 29 00 00       	call   3872 <printf>
      exit();
     ...
     edf:	68 33 42 00 00       	push   $0x4233
     ee4:	6a 01                	push   $0x1
     ee6:	e8 87 29 00 00       	call   3872 <printf>
        exit();
     ...
     f1d:	50                   	push   %eax
     f1e:	68 a8 3f 00 00       	push   $0x3fa8
     f23:	6a 01                	push   $0x1
     f25:	e8 48 29 00 00       	call   3872 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4d:	68 b9 3f 00 00       	push   $0x3fb9
     f52:	6a 01                	push   $0x1
     f54:	e8 19 29 00 00       	call   3872 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     fe9:	56                   	push   %esi
     fea:	68 c5 3f 00 00       	push   $0x3fc5
     fef:	6a 01                	push   $0x1
     ff1:	e8 7c 28 00 00       	call   3872 <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
     ...
     ffe:	68 d6 3f 00 00       	push   $0x3fd6
    1003:	6a 01                	push   $0x1
    1005:	e8 68 28 00 00       	call   3872 <printf>
}
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    101d:	68 e4 3f 00 00       	push   $0x3fe4
    1022:	6a 01                	push   $0x1
    1024:	e8 49 28 00 00       	call   3872 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1051:	68 6d 4a 00 00       	push   $0x4a6d
    1056:	6a 01                	push   $0x1
    1058:	e8 15 28 00 00       	call   3872 <printf>
      exit();
    ...
    1071:	68 33 42 00 00       	push   $0x4233
    1076:	6a 01                	push   $0x1
    1078:	e8 f5 27 00 00       	call   3872 <printf>
          exit();
    ...
    10e2:	68 e5 3b 00 00       	push   $0x3be5
    10e7:	6a 01                	push   $0x1
    10e9:	e8 84 27 00 00       	call   3872 <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    116c:	50                   	push   %eax
    116d:	68 a4 4c 00 00       	push   $0x4ca4
    1172:	6a 01                	push   $0x1
    1174:	e8 f9 26 00 00       	call   3872 <printf>
        exit();
    ...
    1188:	50                   	push   %eax
    1189:	68 c8 4c 00 00       	push   $0x4cc8
    118e:	6a 01                	push   $0x1
    1190:	e8 dd 26 00 00       	call   3872 <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    ...
    11f6:	68 f7 3f 00 00       	push   $0x3ff7
    11fb:	6a 01                	push   $0x1
    11fd:	e8 70 26 00 00       	call   3872 <printf>
}
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1214:	68 08 40 00 00       	push   $0x4008
    1219:	6a 01                	push   $0x1
    121b:	e8 52 26 00 00       	call   3872 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1220:	83 c4 08             	add    $0x8,%esp
    1223:	68 02 02 00 00       	push   $0x202
    1228:	68 19 40 00 00       	push   $0x4019
  ...
  write(fd, "hello", 5);
    ...
    1242:	6a 05                	push   $0x5
    1244:	68 3e 40 00 00       	push   $0x403e
    1249:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    125a:	6a 02                	push   $0x2
    125c:	68 19 40 00 00       	push   $0x4019
  ...
  if(unlink("unlinkread") != 0){
    ...
    1276:	68 19 40 00 00       	push   $0x4019
  ...
  unlink("unlinkread");
    1308:	c7 04 24 19 40 00 00 	movl   $0x4019,(%esp)
    130f:	e8 5c 24 00 00       	call   3770 <unlink>
  printf(1, "unlinkread ok\n");
    1314:	83 c4 08             	add    $0x8,%esp
    1317:	68 c1 40 00 00       	push   $0x40c1
    131c:	6a 01                	push   $0x1
    131e:	e8 4f 25 00 00       	call   3872 <printf>
}
    ...
    1330:	68 24 40 00 00       	push   $0x4024
    1335:	6a 01                	push   $0x1
    1337:	e8 36 25 00 00       	call   3872 <printf>
    exit();
    133c:	e8 df 23 00 00       	call   3720 <exit>
    printf(1, "open unlinkread failed\n");
    1341:	83 ec 08             	sub    $0x8,%esp
    1344:	68 44 40 00 00       	push   $0x4044
    1349:	6a 01                	push   $0x1
    134b:	e8 22 25 00 00       	call   3872 <printf>
    exit();
    1350:	e8 cb 23 00 00       	call   3720 <exit>
    printf(1, "unlink unlinkread failed\n");
    1355:	83 ec 08             	sub    $0x8,%esp
    1358:	68 5c 40 00 00       	push   $0x405c
    135d:	6a 01                	push   $0x1
    135f:	e8 0e 25 00 00       	call   3872 <printf>
    exit();
    1364:	e8 b7 23 00 00       	call   3720 <exit>
    printf(1, "unlinkread read failed");
    1369:	83 ec 08             	sub    $0x8,%esp
    136c:	68 7a 40 00 00       	push   $0x407a
    1371:	6a 01                	push   $0x1
    1373:	e8 fa 24 00 00       	call   3872 <printf>
    exit();
    1378:	e8 a3 23 00 00       	call   3720 <exit>
    printf(1, "unlinkread wrong data\n");
    137d:	83 ec 08             	sub    $0x8,%esp
    1380:	68 91 40 00 00       	push   $0x4091
    1385:	6a 01                	push   $0x1
    1387:	e8 e6 24 00 00       	call   3872 <printf>
    exit();
    138c:	e8 8f 23 00 00       	call   3720 <exit>
    printf(1, "unlinkread write failed\n");
    1391:	83 ec 08             	sub    $0x8,%esp
    1394:	68 a8 40 00 00       	push   $0x40a8
    1399:	6a 01                	push   $0x1
    139b:	e8 d2 24 00 00       	call   3872 <printf>
    exit();
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    13ac:	68 d0 40 00 00       	push   $0x40d0
    13b1:	6a 01                	push   $0x1
    13b3:	e8 ba 24 00 00       	call   3872 <printf>

  unlink("lf1");
    13b8:	c7 04 24 da 40 00 00 	movl   $0x40da,(%esp)
    13bf:	e8 ac 23 00 00       	call   3770 <unlink>
  unlink("lf2");
    13c4:	c7 04 24 de 40 00 00 	movl   $0x40de,(%esp)
    13cb:	e8 a0 23 00 00       	call   3770 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    13d0:	83 c4 08             	add    $0x8,%esp
    13d3:	68 02 02 00 00       	push   $0x202
    13d8:	68 da 40 00 00       	push   $0x40da
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    13f2:	6a 05                	push   $0x5
    13f4:	68 3e 40 00 00       	push   $0x403e
    13f9:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    ...
    1417:	68 de 40 00 00       	push   $0x40de
    141c:	68 da 40 00 00       	push   $0x40da
  ...
  unlink("lf1");
    ...
    1434:	68 da 40 00 00       	push   $0x40da
    1439:	e8 32 23 00 00       	call   3770 <unlink>

  if(open("lf1", 0) >= 0){
    143e:	83 c4 08             	add    $0x8,%esp
    1441:	6a 00                	push   $0x0
    1443:	68 da 40 00 00       	push   $0x40da
  ...
  fd = open("lf2", 0);
    ...
    145b:	6a 00                	push   $0x0
    145d:	68 de 40 00 00       	push   $0x40de
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    14a4:	68 de 40 00 00       	push   $0x40de
  ...
  unlink("lf2");
    ...
    14bc:	68 de 40 00 00       	push   $0x40de
    14c1:	e8 aa 22 00 00       	call   3770 <unlink>
  if(link("lf2", "lf1") >= 0){
    14c6:	83 c4 08             	add    $0x8,%esp
    14c9:	68 da 40 00 00       	push   $0x40da
    14ce:	68 de 40 00 00       	push   $0x40de
  ...
  if(link(".", "lf1") >= 0){
    ...
    14e6:	68 da 40 00 00       	push   $0x40da
    14eb:	68 a2 43 00 00       	push   $0x43a2
  ...
  printf(1, "linktest ok\n");
    ...
    1503:	68 78 41 00 00       	push   $0x4178
    1508:	6a 01                	push   $0x1
    150a:	e8 63 23 00 00       	call   3872 <printf>
}
    ...
    151a:	68 e2 40 00 00       	push   $0x40e2
    151f:	6a 01                	push   $0x1
    1521:	e8 4c 23 00 00       	call   3872 <printf>
    exit();
    1526:	e8 f5 21 00 00       	call   3720 <exit>
    printf(1, "write lf1 failed\n");
    152b:	83 ec 08             	sub    $0x8,%esp
    152e:	68 f5 40 00 00       	push   $0x40f5
    1533:	6a 01                	push   $0x1
    1535:	e8 38 23 00 00       	call   3872 <printf>
    exit();
    153a:	e8 e1 21 00 00       	call   3720 <exit>
    printf(1, "link lf1 lf2 failed\n");
    153f:	83 ec 08             	sub    $0x8,%esp
    1542:	68 07 41 00 00       	push   $0x4107
    1547:	6a 01                	push   $0x1
    1549:	e8 24 23 00 00       	call   3872 <printf>
    exit();
    154e:	e8 cd 21 00 00       	call   3720 <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    1553:	83 ec 08             	sub    $0x8,%esp
    1556:	68 e8 4c 00 00       	push   $0x4ce8
    155b:	6a 01                	push   $0x1
    155d:	e8 10 23 00 00       	call   3872 <printf>
    exit();
    1562:	e8 b9 21 00 00       	call   3720 <exit>
    printf(1, "open lf2 failed\n");
    1567:	83 ec 08             	sub    $0x8,%esp
    156a:	68 1c 41 00 00       	push   $0x411c
    156f:	6a 01                	push   $0x1
    1571:	e8 fc 22 00 00       	call   3872 <printf>
    exit();
    1576:	e8 a5 21 00 00       	call   3720 <exit>
    printf(1, "read lf2 failed\n");
    157b:	83 ec 08             	sub    $0x8,%esp
    157e:	68 2d 41 00 00       	push   $0x412d
    1583:	6a 01                	push   $0x1
    1585:	e8 e8 22 00 00       	call   3872 <printf>
    exit();
    158a:	e8 91 21 00 00       	call   3720 <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    158f:	83 ec 08             	sub    $0x8,%esp
    1592:	68 3e 41 00 00       	push   $0x413e
    1597:	6a 01                	push   $0x1
    1599:	e8 d4 22 00 00       	call   3872 <printf>
    exit();
    159e:	e8 7d 21 00 00       	call   3720 <exit>
    printf(1, "link non-existant succeeded! oops\n");
    15a3:	83 ec 08             	sub    $0x8,%esp
    15a6:	68 10 4d 00 00       	push   $0x4d10
    15ab:	6a 01                	push   $0x1
    15ad:	e8 c0 22 00 00       	call   3872 <printf>
    exit();
    15b2:	e8 69 21 00 00       	call   3720 <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    15b7:	83 ec 08             	sub    $0x8,%esp
    15ba:	68 5c 41 00 00       	push   $0x415c
    15bf:	6a 01                	push   $0x1
    15c1:	e8 ac 22 00 00       	call   3872 <printf>
    exit();
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    15d4:	68 85 41 00 00       	push   $0x4185
    15d9:	6a 01                	push   $0x1
    15db:	e8 92 22 00 00       	call   3872 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    16a3:	50                   	push   %eax
    16a4:	68 95 41 00 00       	push   $0x4195
    ...
    16b9:	50                   	push   %eax
    16ba:	68 95 41 00 00       	push   $0x4195
    ...
    16d2:	50                   	push   %eax
    16d3:	68 98 41 00 00       	push   $0x4198
    16d8:	6a 01                	push   $0x1
    16da:	e8 93 21 00 00       	call   3872 <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    16fc:	6a 00                	push   $0x0
    16fe:	68 a2 43 00 00       	push   $0x43a2
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    175e:	50                   	push   %eax
    175f:	68 b4 41 00 00       	push   $0x41b4
    1764:	6a 01                	push   $0x1
    1766:	e8 07 21 00 00       	call   3872 <printf>
        exit();
    ...
    1776:	50                   	push   %eax
    1777:	68 cd 41 00 00       	push   $0x41cd
    177c:	6a 01                	push   $0x1
    177e:	e8 ef 20 00 00       	call   3872 <printf>
        exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    17a6:	68 34 4d 00 00       	push   $0x4d34
    17ab:	6a 01                	push   $0x1
    17ad:	e8 c0 20 00 00       	call   3872 <printf>
    exit();
    ...
    17ba:	68 6d 4a 00 00       	push   $0x4a6d
    17bf:	6a 01                	push   $0x1
    17c1:	e8 ac 20 00 00       	call   3872 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    ...
    18a2:	68 ea 41 00 00       	push   $0x41ea
    18a7:	6a 01                	push   $0x1
    18a9:	e8 c4 1f 00 00       	call   3872 <printf>
}
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    18c2:	68 f8 41 00 00       	push   $0x41f8
    18c7:	6a 01                	push   $0x1
    18c9:	e8 a4 1f 00 00       	call   3872 <printf>

  unlink("x");
    18ce:	c7 04 24 85 44 00 00 	movl   $0x4485,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    18fb:	68 6d 4a 00 00       	push   $0x4a6d
    1900:	6a 01                	push   $0x1
    1902:	e8 6b 1f 00 00       	call   3872 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    191b:	68 85 44 00 00       	push   $0x4485
  ...
  for(i = 0; i < 100; i++){
    ...
    1960:	68 85 44 00 00       	push   $0x4485
    ...
    1972:	68 85 44 00 00       	push   $0x4485
    1977:	68 09 42 00 00       	push   $0x4209
  ...
  printf(1, "linkunlink ok\n");
    ...
    1992:	68 0d 42 00 00       	push   $0x420d
    1997:	6a 01                	push   $0x1
    1999:	e8 d4 1e 00 00       	call   3872 <printf>
}
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    19b2:	68 1c 42 00 00       	push   $0x421c
    19b7:	6a 01                	push   $0x1
    19b9:	e8 b4 1e 00 00       	call   3872 <printf>
  unlink("bd");
    19be:	c7 04 24 29 42 00 00 	movl   $0x4229,(%esp)
    19c5:	e8 a6 1d 00 00       	call   3770 <unlink>

  fd = open("bd", O_CREATE);
    19ca:	83 c4 08             	add    $0x8,%esp
    19cd:	68 00 02 00 00       	push   $0x200
    19d2:	68 29 42 00 00       	push   $0x4229
  ...
  for(i = 0; i < 500; i++){
    ...
    1a31:	50                   	push   %eax
    1a32:	68 29 42 00 00       	push   $0x4229
  ...
  for(i = 0; i < 500; i++){
    ...
    1a4b:	68 2c 42 00 00       	push   $0x422c
    1a50:	6a 01                	push   $0x1
    1a52:	e8 1b 1e 00 00       	call   3872 <printf>
    exit();
    1a57:	e8 c4 1c 00 00       	call   3720 <exit>
      printf(1, "bigdir link failed\n");
    1a5c:	83 ec 08             	sub    $0x8,%esp
    1a5f:	68 42 42 00 00       	push   $0x4242
    1a64:	6a 01                	push   $0x1
    1a66:	e8 07 1e 00 00       	call   3872 <printf>
      exit();
  ...
  unlink("bd");
    ...
    1a73:	68 29 42 00 00       	push   $0x4229
  ...
  for(i = 0; i < 500; i++){
    ...
    1ad7:	68 56 42 00 00       	push   $0x4256
    1adc:	6a 01                	push   $0x1
    1ade:	e8 8f 1d 00 00       	call   3872 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    ...
    1aeb:	68 6b 42 00 00       	push   $0x426b
    1af0:	6a 01                	push   $0x1
    1af2:	e8 7b 1d 00 00       	call   3872 <printf>
}
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1b06:	68 76 42 00 00       	push   $0x4276
    1b0b:	6a 01                	push   $0x1
    1b0d:	e8 60 1d 00 00       	call   3872 <printf>

  unlink("ff");
    1b12:	c7 04 24 ff 42 00 00 	movl   $0x42ff,(%esp)
    1b19:	e8 52 1c 00 00       	call   3770 <unlink>
  if(mkdir("dd") != 0){
    1b1e:	c7 04 24 9c 43 00 00 	movl   $0x439c,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1b3d:	68 d5 42 00 00       	push   $0x42d5
  ...
  write(fd, "ff", 2);
    ...
    1b57:	6a 02                	push   $0x2
    1b59:	68 ff 42 00 00       	push   $0x42ff
    1b5e:	50                   	push   %eax
  ...
  if(unlink("dd") >= 0){
    1b6c:	c7 04 24 9c 43 00 00 	movl   $0x439c,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1b86:	68 b0 42 00 00       	push   $0x42b0
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ba3:	68 d2 42 00 00       	push   $0x42d2
  ...
  write(fd, "FF", 2);
    ...
    1bbd:	6a 02                	push   $0x2
    1bbf:	68 f3 42 00 00       	push   $0x42f3
    1bc4:	50                   	push   %eax
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1bd5:	6a 00                	push   $0x0
    1bd7:	68 f6 42 00 00       	push   $0x42f6
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    1c26:	68 36 43 00 00       	push   $0x4336
    1c2b:	68 d2 42 00 00       	push   $0x42d2
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1c43:	68 d2 42 00 00       	push   $0x42d2
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1c5b:	6a 00                	push   $0x0
    1c5d:	68 d2 42 00 00       	push   $0x42d2
  ...
  if(chdir("dd") != 0){
    ...
    1c75:	68 9c 43 00 00       	push   $0x439c
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1c8d:	68 6a 43 00 00       	push   $0x436a
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ca5:	68 90 43 00 00       	push   $0x4390
  ...
  if(chdir("./..") != 0){
    ...
    1cbd:	68 9f 43 00 00       	push   $0x439f
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1cd5:	6a 00                	push   $0x0
    1cd7:	68 36 43 00 00       	push   $0x4336
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1d19:	6a 00                	push   $0x0
    1d1b:	68 d2 42 00 00       	push   $0x42d2
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1d38:	68 ea 43 00 00       	push   $0x43ea
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1d55:	68 0f 44 00 00       	push   $0x440f
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1d72:	68 9c 43 00 00       	push   $0x439c
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1d8a:	6a 02                	push   $0x2
    1d8c:	68 9c 43 00 00       	push   $0x439c
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1da4:	6a 01                	push   $0x1
    1da6:	68 9c 43 00 00       	push   $0x439c
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1dbe:	68 7e 44 00 00       	push   $0x447e
    1dc3:	68 ea 43 00 00       	push   $0x43ea
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1ddb:	68 7e 44 00 00       	push   $0x447e
    1de0:	68 0f 44 00 00       	push   $0x440f
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    1df8:	68 36 43 00 00       	push   $0x4336
    1dfd:	68 d5 42 00 00       	push   $0x42d5
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    1e15:	68 ea 43 00 00       	push   $0x43ea
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    1e2d:	68 0f 44 00 00       	push   $0x440f
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    1e45:	68 36 43 00 00       	push   $0x4336
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    1e5d:	68 0f 44 00 00       	push   $0x440f
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    1e75:	68 ea 43 00 00       	push   $0x43ea
  ...
  if(chdir("dd/ff") == 0){
    ...
    1e8d:	68 d5 42 00 00       	push   $0x42d5
  ...
  if(chdir("dd/xx") == 0){
    ...
    1ea5:	68 81 44 00 00       	push   $0x4481
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    1ebd:	68 36 43 00 00       	push   $0x4336
  ...
  if(unlink("dd/ff") != 0){
    ...
    1ed5:	68 d5 42 00 00       	push   $0x42d5
  ...
  if(unlink("dd") == 0){
    ...
    1eed:	68 9c 43 00 00       	push   $0x439c
  ...
  if(unlink("dd/dd") < 0){
    ...
    1f05:	68 b1 42 00 00       	push   $0x42b1
  ...
  if(unlink("dd") < 0){
    ...
    1f1d:	68 9c 43 00 00       	push   $0x439c
  ...
  printf(1, "subdir ok\n");
    ...
    1f35:	68 7e 45 00 00       	push   $0x457e
    1f3a:	6a 01                	push   $0x1
    1f3c:	e8 31 19 00 00       	call   3872 <printf>
}
    ...
    1f4c:	68 83 42 00 00       	push   $0x4283
    1f51:	6a 01                	push   $0x1
    1f53:	e8 1a 19 00 00       	call   3872 <printf>
    exit();
    1f58:	e8 c3 17 00 00       	call   3720 <exit>
    printf(1, "create dd/ff failed\n");
    1f5d:	83 ec 08             	sub    $0x8,%esp
    1f60:	68 9b 42 00 00       	push   $0x429b
    1f65:	6a 01                	push   $0x1
    1f67:	e8 06 19 00 00       	call   3872 <printf>
    exit();
    1f6c:	e8 af 17 00 00       	call   3720 <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    1f71:	83 ec 08             	sub    $0x8,%esp
    1f74:	68 68 4d 00 00       	push   $0x4d68
    1f79:	6a 01                	push   $0x1
    1f7b:	e8 f2 18 00 00       	call   3872 <printf>
    exit();
    1f80:	e8 9b 17 00 00       	call   3720 <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    1f85:	83 ec 08             	sub    $0x8,%esp
    1f88:	68 b7 42 00 00       	push   $0x42b7
    1f8d:	6a 01                	push   $0x1
    1f8f:	e8 de 18 00 00       	call   3872 <printf>
    exit();
    1f94:	e8 87 17 00 00       	call   3720 <exit>
    printf(1, "create dd/dd/ff failed\n");
    1f99:	83 ec 08             	sub    $0x8,%esp
    1f9c:	68 db 42 00 00       	push   $0x42db
    1fa1:	6a 01                	push   $0x1
    1fa3:	e8 ca 18 00 00       	call   3872 <printf>
    exit();
    1fa8:	e8 73 17 00 00       	call   3720 <exit>
    printf(1, "open dd/dd/../ff failed\n");
    1fad:	83 ec 08             	sub    $0x8,%esp
    1fb0:	68 02 43 00 00       	push   $0x4302
    1fb5:	6a 01                	push   $0x1
    1fb7:	e8 b6 18 00 00       	call   3872 <printf>
    exit();
    1fbc:	e8 5f 17 00 00       	call   3720 <exit>
    printf(1, "dd/dd/../ff wrong content\n");
    1fc1:	83 ec 08             	sub    $0x8,%esp
    1fc4:	68 1b 43 00 00       	push   $0x431b
    1fc9:	6a 01                	push   $0x1
    1fcb:	e8 a2 18 00 00       	call   3872 <printf>
    exit();
    1fd0:	e8 4b 17 00 00       	call   3720 <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    1fd5:	83 ec 08             	sub    $0x8,%esp
    1fd8:	68 90 4d 00 00       	push   $0x4d90
    1fdd:	6a 01                	push   $0x1
    1fdf:	e8 8e 18 00 00       	call   3872 <printf>
    exit();
    1fe4:	e8 37 17 00 00       	call   3720 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    1fe9:	83 ec 08             	sub    $0x8,%esp
    1fec:	68 41 43 00 00       	push   $0x4341
    1ff1:	6a 01                	push   $0x1
    1ff3:	e8 7a 18 00 00       	call   3872 <printf>
    exit();
    1ff8:	e8 23 17 00 00       	call   3720 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    1ffd:	83 ec 08             	sub    $0x8,%esp
    2000:	68 b4 4d 00 00       	push   $0x4db4
    2005:	6a 01                	push   $0x1
    2007:	e8 66 18 00 00       	call   3872 <printf>
    exit();
    200c:	e8 0f 17 00 00       	call   3720 <exit>
    printf(1, "chdir dd failed\n");
    2011:	83 ec 08             	sub    $0x8,%esp
    2014:	68 59 43 00 00       	push   $0x4359
    2019:	6a 01                	push   $0x1
    201b:	e8 52 18 00 00       	call   3872 <printf>
    exit();
    2020:	e8 fb 16 00 00       	call   3720 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    2025:	83 ec 08             	sub    $0x8,%esp
    2028:	68 76 43 00 00       	push   $0x4376
    202d:	6a 01                	push   $0x1
    202f:	e8 3e 18 00 00       	call   3872 <printf>
    exit();
    2034:	e8 e7 16 00 00       	call   3720 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    2039:	83 ec 08             	sub    $0x8,%esp
    203c:	68 76 43 00 00       	push   $0x4376
    2041:	6a 01                	push   $0x1
    2043:	e8 2a 18 00 00       	call   3872 <printf>
    exit();
    2048:	e8 d3 16 00 00       	call   3720 <exit>
    printf(1, "chdir ./.. failed\n");
    204d:	83 ec 08             	sub    $0x8,%esp
    2050:	68 a4 43 00 00       	push   $0x43a4
    2055:	6a 01                	push   $0x1
    2057:	e8 16 18 00 00       	call   3872 <printf>
    exit();
    205c:	e8 bf 16 00 00       	call   3720 <exit>
    printf(1, "open dd/dd/ffff failed\n");
    2061:	83 ec 08             	sub    $0x8,%esp
    2064:	68 b7 43 00 00       	push   $0x43b7
    2069:	6a 01                	push   $0x1
    206b:	e8 02 18 00 00       	call   3872 <printf>
    exit();
    2070:	e8 ab 16 00 00       	call   3720 <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    2075:	83 ec 08             	sub    $0x8,%esp
    2078:	68 cf 43 00 00       	push   $0x43cf
    207d:	6a 01                	push   $0x1
    207f:	e8 ee 17 00 00       	call   3872 <printf>
    exit();
    2084:	e8 97 16 00 00       	call   3720 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    2089:	83 ec 08             	sub    $0x8,%esp
    208c:	68 d8 4d 00 00       	push   $0x4dd8
    2091:	6a 01                	push   $0x1
    2093:	e8 da 17 00 00       	call   3872 <printf>
    exit();
    2098:	e8 83 16 00 00       	call   3720 <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    209d:	83 ec 08             	sub    $0x8,%esp
    20a0:	68 f3 43 00 00       	push   $0x43f3
    20a5:	6a 01                	push   $0x1
    20a7:	e8 c6 17 00 00       	call   3872 <printf>
    exit();
    20ac:	e8 6f 16 00 00       	call   3720 <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    20b1:	83 ec 08             	sub    $0x8,%esp
    20b4:	68 18 44 00 00       	push   $0x4418
    20b9:	6a 01                	push   $0x1
    20bb:	e8 b2 17 00 00       	call   3872 <printf>
    exit();
    20c0:	e8 5b 16 00 00       	call   3720 <exit>
    printf(1, "create dd succeeded!\n");
    20c5:	83 ec 08             	sub    $0x8,%esp
    20c8:	68 34 44 00 00       	push   $0x4434
    20cd:	6a 01                	push   $0x1
    20cf:	e8 9e 17 00 00       	call   3872 <printf>
    exit();
    20d4:	e8 47 16 00 00       	call   3720 <exit>
    printf(1, "open dd rdwr succeeded!\n");
    20d9:	83 ec 08             	sub    $0x8,%esp
    20dc:	68 4a 44 00 00       	push   $0x444a
    20e1:	6a 01                	push   $0x1
    20e3:	e8 8a 17 00 00       	call   3872 <printf>
    exit();
    20e8:	e8 33 16 00 00       	call   3720 <exit>
    printf(1, "open dd wronly succeeded!\n");
    20ed:	83 ec 08             	sub    $0x8,%esp
    20f0:	68 63 44 00 00       	push   $0x4463
    20f5:	6a 01                	push   $0x1
    20f7:	e8 76 17 00 00       	call   3872 <printf>
    exit();
    20fc:	e8 1f 16 00 00       	call   3720 <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    2101:	83 ec 08             	sub    $0x8,%esp
    2104:	68 00 4e 00 00       	push   $0x4e00
    2109:	6a 01                	push   $0x1
    210b:	e8 62 17 00 00       	call   3872 <printf>
    exit();
    2110:	e8 0b 16 00 00       	call   3720 <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2115:	83 ec 08             	sub    $0x8,%esp
    2118:	68 24 4e 00 00       	push   $0x4e24
    211d:	6a 01                	push   $0x1
    211f:	e8 4e 17 00 00       	call   3872 <printf>
    exit();
    2124:	e8 f7 15 00 00       	call   3720 <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    2129:	83 ec 08             	sub    $0x8,%esp
    212c:	68 48 4e 00 00       	push   $0x4e48
    2131:	6a 01                	push   $0x1
    2133:	e8 3a 17 00 00       	call   3872 <printf>
    exit();
    2138:	e8 e3 15 00 00       	call   3720 <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    213d:	83 ec 08             	sub    $0x8,%esp
    2140:	68 87 44 00 00       	push   $0x4487
    2145:	6a 01                	push   $0x1
    2147:	e8 26 17 00 00       	call   3872 <printf>
    exit();
    214c:	e8 cf 15 00 00       	call   3720 <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    2151:	83 ec 08             	sub    $0x8,%esp
    2154:	68 a2 44 00 00       	push   $0x44a2
    2159:	6a 01                	push   $0x1
    215b:	e8 12 17 00 00       	call   3872 <printf>
    exit();
    2160:	e8 bb 15 00 00       	call   3720 <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    2165:	83 ec 08             	sub    $0x8,%esp
    2168:	68 bd 44 00 00       	push   $0x44bd
    216d:	6a 01                	push   $0x1
    216f:	e8 fe 16 00 00       	call   3872 <printf>
    exit();
    2174:	e8 a7 15 00 00       	call   3720 <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    2179:	83 ec 08             	sub    $0x8,%esp
    217c:	68 da 44 00 00       	push   $0x44da
    2181:	6a 01                	push   $0x1
    2183:	e8 ea 16 00 00       	call   3872 <printf>
    exit();
    2188:	e8 93 15 00 00       	call   3720 <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    218d:	83 ec 08             	sub    $0x8,%esp
    2190:	68 f6 44 00 00       	push   $0x44f6
    2195:	6a 01                	push   $0x1
    2197:	e8 d6 16 00 00       	call   3872 <printf>
    exit();
    219c:	e8 7f 15 00 00       	call   3720 <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    21a1:	83 ec 08             	sub    $0x8,%esp
    21a4:	68 12 45 00 00       	push   $0x4512
    21a9:	6a 01                	push   $0x1
    21ab:	e8 c2 16 00 00       	call   3872 <printf>
    exit();
    21b0:	e8 6b 15 00 00       	call   3720 <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    21b5:	83 ec 08             	sub    $0x8,%esp
    21b8:	68 2a 45 00 00       	push   $0x452a
    21bd:	6a 01                	push   $0x1
    21bf:	e8 ae 16 00 00       	call   3872 <printf>
    exit();
    21c4:	e8 57 15 00 00       	call   3720 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    21c9:	83 ec 08             	sub    $0x8,%esp
    21cc:	68 41 43 00 00       	push   $0x4341
    21d1:	6a 01                	push   $0x1
    21d3:	e8 9a 16 00 00       	call   3872 <printf>
    exit();
    21d8:	e8 43 15 00 00       	call   3720 <exit>
    printf(1, "unlink dd/ff failed\n");
    21dd:	83 ec 08             	sub    $0x8,%esp
    21e0:	68 42 45 00 00       	push   $0x4542
    21e5:	6a 01                	push   $0x1
    21e7:	e8 86 16 00 00       	call   3872 <printf>
    exit();
    21ec:	e8 2f 15 00 00       	call   3720 <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    21f1:	83 ec 08             	sub    $0x8,%esp
    21f4:	68 6c 4e 00 00       	push   $0x4e6c
    21f9:	6a 01                	push   $0x1
    21fb:	e8 72 16 00 00       	call   3872 <printf>
    exit();
    2200:	e8 1b 15 00 00       	call   3720 <exit>
    printf(1, "unlink dd/dd failed\n");
    2205:	83 ec 08             	sub    $0x8,%esp
    2208:	68 57 45 00 00       	push   $0x4557
    220d:	6a 01                	push   $0x1
    220f:	e8 5e 16 00 00       	call   3872 <printf>
    exit();
    2214:	e8 07 15 00 00       	call   3720 <exit>
    printf(1, "unlink dd failed\n");
    2219:	83 ec 08             	sub    $0x8,%esp
    221c:	68 6c 45 00 00       	push   $0x456c
    2221:	6a 01                	push   $0x1
    2223:	e8 4a 16 00 00       	call   3872 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2236:	68 89 45 00 00       	push   $0x4589
    223b:	6a 01                	push   $0x1
    223d:	e8 30 16 00 00       	call   3872 <printf>

  unlink("bigwrite");
    2242:	c7 04 24 98 45 00 00 	movl   $0x4598,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    225b:	68 a1 45 00 00       	push   $0x45a1
    2260:	6a 01                	push   $0x1
    2262:	e8 0b 16 00 00       	call   3872 <printf>
      exit();
    ...
    226c:	50                   	push   %eax
    226d:	56                   	push   %esi
    226e:	68 b9 45 00 00       	push   $0x45b9
    2273:	6a 01                	push   $0x1
    2275:	e8 f8 15 00 00       	call   3872 <printf>
        exit();
    ...
    unlink("bigwrite");
    2288:	c7 04 24 98 45 00 00 	movl   $0x4598,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    22ad:	68 98 45 00 00       	push   $0x4598
  ...
  printf(1, "bigwrite ok\n");
    ...
    22e8:	68 cb 45 00 00       	push   $0x45cb
    22ed:	6a 01                	push   $0x1
    22ef:	e8 7e 15 00 00       	call   3872 <printf>
}
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    2308:	68 d8 45 00 00       	push   $0x45d8
    230d:	6a 01                	push   $0x1
    230f:	e8 5e 15 00 00       	call   3872 <printf>

  unlink("bigfile");
    2314:	c7 04 24 f4 45 00 00 	movl   $0x45f4,(%esp)
    231b:	e8 50 14 00 00       	call   3770 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2320:	83 c4 08             	add    $0x8,%esp
    2323:	68 02 02 00 00       	push   $0x202
    2328:	68 f4 45 00 00       	push   $0x45f4
  ...
  for(i = 0; i < 20; i++){
    ...
    2345:	68 e6 45 00 00       	push   $0x45e6
    234a:	6a 01                	push   $0x1
    234c:	e8 21 15 00 00       	call   3872 <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2391:	68 fc 45 00 00       	push   $0x45fc
    2396:	6a 01                	push   $0x1
    2398:	e8 d5 14 00 00       	call   3872 <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    23ae:	6a 00                	push   $0x0
    23b0:	68 f4 45 00 00       	push   $0x45f4
  ...
  for(i = 0; ; i++){
    ...
    241b:	68 12 46 00 00       	push   $0x4612
    2420:	6a 01                	push   $0x1
    2422:	e8 4b 14 00 00       	call   3872 <printf>
    exit();
    2427:	e8 f4 12 00 00       	call   3720 <exit>
      printf(1, "read bigfile failed\n");
    242c:	83 ec 08             	sub    $0x8,%esp
    242f:	68 27 46 00 00       	push   $0x4627
    2434:	6a 01                	push   $0x1
    2436:	e8 37 14 00 00       	call   3872 <printf>
      exit();
    243b:	e8 e0 12 00 00       	call   3720 <exit>
      printf(1, "short read bigfile\n");
    2440:	83 ec 08             	sub    $0x8,%esp
    2443:	68 3c 46 00 00       	push   $0x463c
    2448:	6a 01                	push   $0x1
    244a:	e8 23 14 00 00       	call   3872 <printf>
      exit();
    244f:	e8 cc 12 00 00       	call   3720 <exit>
      printf(1, "read bigfile wrong data\n");
    2454:	83 ec 08             	sub    $0x8,%esp
    2457:	68 50 46 00 00       	push   $0x4650
    245c:	6a 01                	push   $0x1
    245e:	e8 0f 14 00 00       	call   3872 <printf>
      exit();
  ...
  unlink("bigfile");
    ...
    247f:	68 f4 45 00 00       	push   $0x45f4
    2484:	e8 e7 12 00 00       	call   3770 <unlink>

  printf(1, "bigfile test ok\n");
    2489:	83 c4 08             	add    $0x8,%esp
    248c:	68 83 46 00 00       	push   $0x4683
    2491:	6a 01                	push   $0x1
    2493:	e8 da 13 00 00       	call   3872 <printf>
}
    ...
    24a6:	68 69 46 00 00       	push   $0x4669
    24ab:	6a 01                	push   $0x1
    24ad:	e8 c0 13 00 00       	call   3872 <printf>
    exit();
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    24bd:	68 94 46 00 00       	push   $0x4694
    24c2:	6a 01                	push   $0x1
    24c4:	e8 a9 13 00 00       	call   3872 <printf>

  if(mkdir("12345678901234") != 0){
    24c9:	c7 04 24 cf 46 00 00 	movl   $0x46cf,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    24e3:	68 8c 4e 00 00       	push   $0x4e8c
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2500:	68 dc 4e 00 00       	push   $0x4edc
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2521:	6a 00                	push   $0x0
    2523:	68 4c 4f 00 00       	push   $0x4f4c
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    2541:	c7 04 24 c0 46 00 00 	movl   $0x46c0,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2557:	68 e8 4f 00 00       	push   $0x4fe8
  ...
  printf(1, "fourteen ok\n");
    ...
    256b:	68 de 46 00 00       	push   $0x46de
    2570:	6a 01                	push   $0x1
    2572:	e8 fb 12 00 00       	call   3872 <printf>
}
    ...
    257f:	68 a3 46 00 00       	push   $0x46a3
    2584:	6a 01                	push   $0x1
    2586:	e8 e7 12 00 00       	call   3872 <printf>
    exit();
    258b:	e8 90 11 00 00       	call   3720 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    2590:	83 ec 08             	sub    $0x8,%esp
    2593:	68 ac 4e 00 00       	push   $0x4eac
    2598:	6a 01                	push   $0x1
    259a:	e8 d3 12 00 00       	call   3872 <printf>
    exit();
    259f:	e8 7c 11 00 00       	call   3720 <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    25a4:	83 ec 08             	sub    $0x8,%esp
    25a7:	68 0c 4f 00 00       	push   $0x4f0c
    25ac:	6a 01                	push   $0x1
    25ae:	e8 bf 12 00 00       	call   3872 <printf>
    exit();
    25b3:	e8 68 11 00 00       	call   3720 <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    25b8:	83 ec 08             	sub    $0x8,%esp
    25bb:	68 7c 4f 00 00       	push   $0x4f7c
    25c0:	6a 01                	push   $0x1
    25c2:	e8 ab 12 00 00       	call   3872 <printf>
    exit();
    25c7:	e8 54 11 00 00       	call   3720 <exit>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    25cc:	83 ec 08             	sub    $0x8,%esp
    25cf:	68 b8 4f 00 00       	push   $0x4fb8
    25d4:	6a 01                	push   $0x1
    25d6:	e8 97 12 00 00       	call   3872 <printf>
    exit();
    25db:	e8 40 11 00 00       	call   3720 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    25e0:	83 ec 08             	sub    $0x8,%esp
    25e3:	68 08 50 00 00       	push   $0x5008
    25e8:	6a 01                	push   $0x1
    25ea:	e8 83 12 00 00       	call   3872 <printf>
    exit();
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    25fa:	68 eb 46 00 00       	push   $0x46eb
    25ff:	6a 01                	push   $0x1
    2601:	e8 6c 12 00 00       	call   3872 <printf>
  if(mkdir("dots") != 0){
    2606:	c7 04 24 f7 46 00 00 	movl   $0x46f7,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    2620:	68 f7 46 00 00       	push   $0x46f7
  ...
  if(unlink(".") == 0){
    ...
    2638:	68 a2 43 00 00       	push   $0x43a2
  ...
  if(unlink("..") == 0){
    ...
    2650:	68 a1 43 00 00       	push   $0x43a1
  ...
  if(chdir("/") != 0){
    ...
    2668:	68 75 3b 00 00       	push   $0x3b75
  ...
  if(unlink("dots/.") == 0){
    ...
    2680:	68 3f 47 00 00       	push   $0x473f
  ...
  if(unlink("dots/..") == 0){
    ...
    2698:	68 5d 47 00 00       	push   $0x475d
  ...
  if(unlink("dots") != 0){
    ...
    26b0:	68 f7 46 00 00       	push   $0x46f7
  ...
  printf(1, "rmdot ok\n");
    ...
    26c8:	68 92 47 00 00       	push   $0x4792
    26cd:	6a 01                	push   $0x1
    26cf:	e8 9e 11 00 00       	call   3872 <printf>
}
    ...
    26dc:	68 fc 46 00 00       	push   $0x46fc
    26e1:	6a 01                	push   $0x1
    26e3:	e8 8a 11 00 00       	call   3872 <printf>
    exit();
    26e8:	e8 33 10 00 00       	call   3720 <exit>
    printf(1, "chdir dots failed\n");
    26ed:	83 ec 08             	sub    $0x8,%esp
    26f0:	68 0f 47 00 00       	push   $0x470f
    26f5:	6a 01                	push   $0x1
    26f7:	e8 76 11 00 00       	call   3872 <printf>
    exit();
    26fc:	e8 1f 10 00 00       	call   3720 <exit>
    printf(1, "rm . worked!\n");
    2701:	83 ec 08             	sub    $0x8,%esp
    2704:	68 22 47 00 00       	push   $0x4722
    2709:	6a 01                	push   $0x1
    270b:	e8 62 11 00 00       	call   3872 <printf>
    exit();
    2710:	e8 0b 10 00 00       	call   3720 <exit>
    printf(1, "rm .. worked!\n");
    2715:	83 ec 08             	sub    $0x8,%esp
    2718:	68 30 47 00 00       	push   $0x4730
    271d:	6a 01                	push   $0x1
    271f:	e8 4e 11 00 00       	call   3872 <printf>
    exit();
    2724:	e8 f7 0f 00 00       	call   3720 <exit>
    printf(1, "chdir / failed\n");
    2729:	83 ec 08             	sub    $0x8,%esp
    272c:	68 77 3b 00 00       	push   $0x3b77
    2731:	6a 01                	push   $0x1
    2733:	e8 3a 11 00 00       	call   3872 <printf>
    exit();
    2738:	e8 e3 0f 00 00       	call   3720 <exit>
    printf(1, "unlink dots/. worked!\n");
    273d:	83 ec 08             	sub    $0x8,%esp
    2740:	68 46 47 00 00       	push   $0x4746
    2745:	6a 01                	push   $0x1
    2747:	e8 26 11 00 00       	call   3872 <printf>
    exit();
    274c:	e8 cf 0f 00 00       	call   3720 <exit>
    printf(1, "unlink dots/.. worked!\n");
    2751:	83 ec 08             	sub    $0x8,%esp
    2754:	68 65 47 00 00       	push   $0x4765
    2759:	6a 01                	push   $0x1
    275b:	e8 12 11 00 00       	call   3872 <printf>
    exit();
    2760:	e8 bb 0f 00 00       	call   3720 <exit>
    printf(1, "unlink dots failed!\n");
    2765:	83 ec 08             	sub    $0x8,%esp
    2768:	68 7d 47 00 00       	push   $0x477d
    276d:	6a 01                	push   $0x1
    276f:	e8 fe 10 00 00       	call   3872 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2780:	68 9c 47 00 00       	push   $0x479c
    2785:	6a 01                	push   $0x1
    2787:	e8 e6 10 00 00       	call   3872 <printf>

  fd = open("dirfile", O_CREATE);
    278c:	83 c4 08             	add    $0x8,%esp
    278f:	68 00 02 00 00       	push   $0x200
    2794:	68 a9 47 00 00       	push   $0x47a9
  ...
  if(chdir("dirfile") == 0){
    27b2:	c7 04 24 a9 47 00 00 	movl   $0x47a9,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    27cc:	6a 00                	push   $0x0
    27ce:	68 e2 47 00 00       	push   $0x47e2
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    27eb:	68 e2 47 00 00       	push   $0x47e2
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2803:	68 e2 47 00 00       	push   $0x47e2
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    281b:	68 e2 47 00 00       	push   $0x47e2
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2833:	68 e2 47 00 00       	push   $0x47e2
    2838:	68 46 48 00 00       	push   $0x4846
  ...
  if(unlink("dirfile") != 0){
    ...
    2850:	68 a9 47 00 00       	push   $0x47a9
  ...
  fd = open(".", O_RDWR);
    ...
    2868:	6a 02                	push   $0x2
    286a:	68 a2 43 00 00       	push   $0x43a2
  ...
  printf(1, "dir vs file OK\n");
    ...
    28b7:	68 79 48 00 00       	push   $0x4879
    28bc:	6a 01                	push   $0x1
    28be:	e8 af 0f 00 00       	call   3872 <printf>
}
    ...
    28ce:	68 b1 47 00 00       	push   $0x47b1
    28d3:	6a 01                	push   $0x1
    28d5:	e8 98 0f 00 00       	call   3872 <printf>
    exit();
    28da:	e8 41 0e 00 00       	call   3720 <exit>
    printf(1, "chdir dirfile succeeded!\n");
    28df:	83 ec 08             	sub    $0x8,%esp
    28e2:	68 c8 47 00 00       	push   $0x47c8
    28e7:	6a 01                	push   $0x1
    28e9:	e8 84 0f 00 00       	call   3872 <printf>
    exit();
    28ee:	e8 2d 0e 00 00       	call   3720 <exit>
    printf(1, "create dirfile/xx succeeded!\n");
    28f3:	83 ec 08             	sub    $0x8,%esp
    28f6:	68 ed 47 00 00       	push   $0x47ed
    28fb:	6a 01                	push   $0x1
    28fd:	e8 70 0f 00 00       	call   3872 <printf>
    exit();
    2902:	e8 19 0e 00 00       	call   3720 <exit>
    printf(1, "create dirfile/xx succeeded!\n");
    2907:	83 ec 08             	sub    $0x8,%esp
    290a:	68 ed 47 00 00       	push   $0x47ed
    290f:	6a 01                	push   $0x1
    2911:	e8 5c 0f 00 00       	call   3872 <printf>
    exit();
    2916:	e8 05 0e 00 00       	call   3720 <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    291b:	83 ec 08             	sub    $0x8,%esp
    291e:	68 0b 48 00 00       	push   $0x480b
    2923:	6a 01                	push   $0x1
    2925:	e8 48 0f 00 00       	call   3872 <printf>
    exit();
    292a:	e8 f1 0d 00 00       	call   3720 <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    292f:	83 ec 08             	sub    $0x8,%esp
    2932:	68 28 48 00 00       	push   $0x4828
    2937:	6a 01                	push   $0x1
    2939:	e8 34 0f 00 00       	call   3872 <printf>
    exit();
    293e:	e8 dd 0d 00 00       	call   3720 <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    2943:	83 ec 08             	sub    $0x8,%esp
    2946:	68 3c 50 00 00       	push   $0x503c
    294b:	6a 01                	push   $0x1
    294d:	e8 20 0f 00 00       	call   3872 <printf>
    exit();
    2952:	e8 c9 0d 00 00       	call   3720 <exit>
    printf(1, "unlink dirfile failed!\n");
    2957:	83 ec 08             	sub    $0x8,%esp
    295a:	68 4d 48 00 00       	push   $0x484d
    295f:	6a 01                	push   $0x1
    2961:	e8 0c 0f 00 00       	call   3872 <printf>
    exit();
    2966:	e8 b5 0d 00 00       	call   3720 <exit>
    printf(1, "open . for writing succeeded!\n");
    296b:	83 ec 08             	sub    $0x8,%esp
    296e:	68 5c 50 00 00       	push   $0x505c
    2973:	6a 01                	push   $0x1
    2975:	e8 f8 0e 00 00       	call   3872 <printf>
    exit();
    297a:	e8 a1 0d 00 00       	call   3720 <exit>
    printf(1, "write . succeeded!\n");
    297f:	83 ec 08             	sub    $0x8,%esp
    2982:	68 65 48 00 00       	push   $0x4865
    2987:	6a 01                	push   $0x1
    2989:	e8 e4 0e 00 00       	call   3872 <printf>
    exit();
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    299a:	68 89 48 00 00       	push   $0x4889
    299f:	6a 01                	push   $0x1
    29a1:	e8 cc 0e 00 00       	call   3872 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    29b3:	68 a0 48 00 00       	push   $0x48a0
    29b8:	6a 01                	push   $0x1
    29ba:	e8 b3 0e 00 00       	call   3872 <printf>
      exit();
    ...
    29c7:	68 b4 48 00 00       	push   $0x48b4
    29cc:	6a 01                	push   $0x1
    29ce:	e8 9f 0e 00 00       	call   3872 <printf>
      exit();
    ...
    29ec:	68 84 44 00 00       	push   $0x4484
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2a08:	68 9a 48 00 00       	push   $0x489a
    ...
    2a1c:	68 9a 48 00 00       	push   $0x489a
    ...
    2a71:	68 84 44 00 00       	push   $0x4484
  ...
  chdir("/");
    ...
    2a9a:	68 75 3b 00 00       	push   $0x3b75
    2a9f:	e8 ec 0c 00 00       	call   3790 <chdir>
  printf(1, "empty file name OK\n");
    2aa4:	83 c4 08             	add    $0x8,%esp
    2aa7:	68 c8 48 00 00       	push   $0x48c8
    2aac:	6a 01                	push   $0x1
    2aae:	e8 bf 0d 00 00       	call   3872 <printf>
}
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2ac2:	68 dc 48 00 00       	push   $0x48dc
    2ac7:	6a 01                	push   $0x1
    2ac9:	e8 a4 0d 00 00       	call   3872 <printf>
  ...
  for(; n > 0; n--){
    ...
    2b12:	68 7c 50 00 00       	push   $0x507c
    2b17:	6a 01                	push   $0x1
    2b19:	e8 54 0d 00 00       	call   3872 <printf>
    exit();
    2b1e:	e8 fd 0b 00 00       	call   3720 <exit>
      printf(1, "wait stopped early\n");
    2b23:	83 ec 08             	sub    $0x8,%esp
    2b26:	68 e7 48 00 00       	push   $0x48e7
    2b2b:	6a 01                	push   $0x1
    2b2d:	e8 40 0d 00 00       	call   3872 <printf>
      exit();
  ...
  printf(1, "fork test OK\n");
    ...
    2b44:	68 0e 49 00 00       	push   $0x490e
    2b49:	6a 01                	push   $0x1
    2b4b:	e8 22 0d 00 00       	call   3872 <printf>
}
    ...
    2b5b:	68 fb 48 00 00       	push   $0x48fb
    2b60:	6a 01                	push   $0x1
    2b62:	e8 0b 0d 00 00       	call   3872 <printf>
    exit();
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2b75:	68 1c 49 00 00       	push   $0x491c
    2b7a:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    2b80:	e8 ed 0c 00 00       	call   3872 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){
    ...
    2bd1:	56                   	push   %esi
    2bd2:	53                   	push   %ebx
    2bd3:	68 27 49 00 00       	push   $0x4927
    2bd8:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    2bde:	e8 8f 0c 00 00       	call   3872 <printf>
      exit();
...
#define BIG (100*1024*1024)
  ...
  *lastaddr = 99;
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2d50:	68 42 49 00 00       	push   $0x4942
    2d55:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    2d5b:	e8 12 0b 00 00       	call   3872 <printf>
    exit();
    2d60:	e8 bb 09 00 00       	call   3720 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    2d65:	83 ec 08             	sub    $0x8,%esp
    2d68:	68 59 49 00 00       	push   $0x4959
    2d6d:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    2d73:	e8 fa 0a 00 00       	call   3872 <printf>
    exit();
    ...
    2d85:	68 a0 50 00 00       	push   $0x50a0
    2d8a:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    2d90:	e8 dd 0a 00 00       	call   3872 <printf>
    exit();
    2d95:	e8 86 09 00 00       	call   3720 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    2d9a:	83 ec 08             	sub    $0x8,%esp
    2d9d:	68 75 49 00 00       	push   $0x4975
    2da2:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    2da8:	e8 c5 0a 00 00       	call   3872 <printf>
    exit();
    2dad:	e8 6e 09 00 00       	call   3720 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    2db2:	50                   	push   %eax
    2db3:	53                   	push   %ebx
    2db4:	68 e0 50 00 00       	push   $0x50e0
    2db9:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    2dbf:	e8 ae 0a 00 00       	call   3872 <printf>
    exit();
    2dc4:	e8 57 09 00 00       	call   3720 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    2dc9:	56                   	push   %esi
    2dca:	53                   	push   %ebx
    2dcb:	68 18 51 00 00       	push   $0x5118
    2dd0:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    2dd6:	e8 97 0a 00 00       	call   3872 <printf>
    exit();
    2ddb:	e8 40 09 00 00       	call   3720 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    2de0:	83 ec 08             	sub    $0x8,%esp
    2de3:	68 40 51 00 00       	push   $0x5140
    2de8:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    2dee:	e8 7f 0a 00 00       	call   3872 <printf>
    exit();
    2df3:	e8 28 09 00 00       	call   3720 <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    2df8:	50                   	push   %eax
    2df9:	53                   	push   %ebx
    2dfa:	68 70 51 00 00       	push   $0x5170
    2dff:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    2e05:	e8 68 0a 00 00       	call   3872 <printf>
    exit();
    2e0a:	e8 11 09 00 00       	call   3720 <exit>
      printf(stdout, "fork failed\n");
    2e0f:	83 ec 08             	sub    $0x8,%esp
    2e12:	68 6d 4a 00 00       	push   $0x4a6d
    2e17:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    2e1d:	e8 50 0a 00 00       	call   3872 <printf>
      exit();
    ...
    2e2a:	50                   	push   %eax
    2e2b:	53                   	push   %ebx
    2e2c:	68 90 49 00 00       	push   $0x4990
    2e31:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    2e37:	e8 36 0a 00 00       	call   3872 <printf>
      kill(ppid);
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2e65:	68 65 3e 00 00       	push   $0x3e65
    2e6a:	6a 01                	push   $0x1
    2e6c:	e8 01 0a 00 00       	call   3872 <printf>
    exit();
    ...
    2e92:	6a 01                	push   $0x1
    2e94:	68 85 44 00 00       	push   $0x4485
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2f37:	68 c4 49 00 00       	push   $0x49c4
    2f3c:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    2f42:	e8 2b 09 00 00       	call   3872 <printf>
}
    ...
    2f55:	68 a9 49 00 00       	push   $0x49a9
    2f5a:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    2f60:	e8 0d 09 00 00       	call   3872 <printf>
    exit();
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    2f90:	68 d2 49 00 00       	push   $0x49d2
    2f95:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    2f9b:	e8 d2 08 00 00       	call   3872 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    2fe1:	53                   	push   %ebx
    2fe2:	68 e1 49 00 00       	push   $0x49e1
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3004:	68 ec 49 00 00       	push   $0x49ec
    3009:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    300f:	e8 5e 08 00 00       	call   3872 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    ...
    301c:	68 05 4a 00 00       	push   $0x4a05
    3021:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    3027:	e8 46 08 00 00       	call   3872 <printf>
}
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    303c:	68 12 4a 00 00       	push   $0x4a12
    3041:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    3047:	e8 26 08 00 00       	call   3872 <printf>
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    306c:	68 1c 4a 00 00       	push   $0x4a1c
    3071:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    3077:	e8 f6 07 00 00       	call   3872 <printf>
      exit();
  ...
  printf(stdout, "bss test ok\n");
    ...
    3084:	68 2d 4a 00 00       	push   $0x4a2d
    3089:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    308f:	e8 de 07 00 00       	call   3872 <printf>
}
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    309f:	68 3a 4a 00 00       	push   $0x4a3a
  ...
  fd = open("bigarg-ok", 0);
    ...
    30c5:	6a 00                	push   $0x0
    30c7:	68 3a 4a 00 00       	push   $0x4a3a
  ...
  unlink("bigarg-ok");
    30e5:	c7 04 24 3a 4a 00 00 	movl   $0x4a3a,(%esp)
    ...
    30f6:	c7 04 85 a0 5b 00 00 	movl   $0x5194,0x5ba0(,%eax,4)
    30fd:	94 51 00 00 
    ...
    3116:	68 44 4a 00 00       	push   $0x4a44
    311b:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    3121:	e8 4c 07 00 00       	call   3872 <printf>
    exec("echo", args);
    3126:	83 c4 08             	add    $0x8,%esp
    3129:	68 a0 5b 00 00       	push   $0x5ba0
    312e:	68 11 3c 00 00       	push   $0x3c11
    3133:	e8 20 06 00 00       	call   3758 <exec>
    printf(stdout, "bigarg test ok\n");
    3138:	83 c4 08             	add    $0x8,%esp
    313b:	68 51 4a 00 00       	push   $0x4a51
    3140:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    3146:	e8 27 07 00 00       	call   3872 <printf>
    fd = open("bigarg-ok", O_CREATE);
    314b:	83 c4 08             	add    $0x8,%esp
    314e:	68 00 02 00 00       	push   $0x200
    3153:	68 3a 4a 00 00       	push   $0x4a3a
    ...
    316d:	68 61 4a 00 00       	push   $0x4a61
    3172:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    3178:	e8 f5 06 00 00       	call   3872 <printf>
    exit();
    317d:	e8 9e 05 00 00       	call   3720 <exit>
    printf(stdout, "bigarg test failed!\n");
    3182:	83 ec 08             	sub    $0x8,%esp
    3185:	68 7a 4a 00 00       	push   $0x4a7a
    318a:	ff 35 6c 5b 00 00    	pushl  0x5b6c
    3190:	e8 dd 06 00 00       	call   3872 <printf>
    exit();
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    31a3:	68 8f 4a 00 00       	push   $0x4a8f
    31a8:	6a 01                	push   $0x1
    31aa:	e8 c3 06 00 00       	call   3872 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3241:	56                   	push   %esi
    3242:	68 9c 4a 00 00       	push   $0x4a9c
    3247:	6a 01                	push   $0x1
    3249:	e8 24 06 00 00       	call   3872 <printf>
    ...
    326b:	50                   	push   %eax
    326c:	68 a8 4a 00 00       	push   $0x4aa8
    3271:	6a 01                	push   $0x1
    3273:	e8 fa 05 00 00       	call   3872 <printf>
      break;
    ...
    32a9:	57                   	push   %edi
    32aa:	68 b8 4a 00 00       	push   $0x4ab8
    32af:	6a 01                	push   $0x1
    32b1:	e8 bc 05 00 00       	call   3872 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    ...
    3372:	68 c8 4a 00 00       	push   $0x4ac8
    3377:	6a 01                	push   $0x1
    3379:	e8 f4 04 00 00       	call   3872 <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    338f:	68 de 4a 00 00       	push   $0x4ade
    3394:	6a 01                	push   $0x1
    3396:	e8 d7 04 00 00       	call   3872 <printf>
  pid = fork();
  ...
  printf(1, "uio test done\n");
    ...
    33b3:	68 e8 4a 00 00       	push   $0x4ae8
    33b8:	6a 01                	push   $0x1
    33ba:	e8 b3 04 00 00       	call   3872 <printf>
}
    ...
    33d8:	68 74 52 00 00       	push   $0x5274
    33dd:	6a 01                	push   $0x1
    33df:	e8 8e 04 00 00       	call   3872 <printf>
    exit();
    33e4:	e8 37 03 00 00       	call   3720 <exit>
    printf (1, "fork failed\n");
    33e9:	83 ec 08             	sub    $0x8,%esp
    33ec:	68 6d 4a 00 00       	push   $0x4a6d
    33f1:	6a 01                	push   $0x1
    33f3:	e8 7a 04 00 00       	call   3872 <printf>
    exit();
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    3404:	6a 00                	push   $0x0
    3406:	68 f7 4a 00 00       	push   $0x4af7
  ...
  printf(1, "arg test passed\n");
    ...
    343d:	68 09 4b 00 00       	push   $0x4b09
    3442:	6a 01                	push   $0x1
    3444:	e8 29 04 00 00       	call   3872 <printf>
}
    ...
    3454:	68 fc 4a 00 00       	push   $0x4afc
    3459:	6a 02                	push   $0x2
    345b:	e8 12 04 00 00       	call   3872 <printf>
    exit();
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3468:	69 05 68 5b 00 00 0d 	imul   $0x19660d,0x5b68,%eax
    346f:	66 19 00 
    3472:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3477:	a3 68 5b 00 00       	mov    %eax,0x5b68
  return randstate;
}
    347c:	5d                   	pop    %ebp
    347d:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    348f:	68 1a 4b 00 00       	push   $0x4b1a
    3494:	6a 01                	push   $0x1
    3496:	e8 d7 03 00 00       	call   3872 <printf>

  if(open("usertests.ran", 0) >= 0){
    349b:	83 c4 08             	add    $0x8,%esp
    349e:	6a 00                	push   $0x0
    34a0:	68 2e 4b 00 00       	push   $0x4b2e
    ...
    34b4:	68 98 52 00 00       	push   $0x5298
    34b9:	6a 01                	push   $0x1
    34bb:	e8 b2 03 00 00       	call   3872 <printf>
    exit();
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    34cd:	68 2e 4b 00 00       	push   $0x4b2e
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    37e6:	52                   	push   %edx
    37e7:	50                   	push   %eax
    37e8:	e8 53 ff ff ff       	call   3740 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
    37fd:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    3801:	0f 95 c3             	setne  %bl
    3804:	89 d0                	mov    %edx,%eax
    3806:	c1 e8 1f             	shr    $0x1f,%eax
    3809:	84 c3                	test   %al,%bl
    380b:	74 10                	je     381d <printint+0x2b>
    neg = 1;
    x = -xx;
    380d:	f7 da                	neg    %edx
    neg = 1;
    380f:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
    3816:	be 00 00 00 00       	mov    $0x0,%esi
    381b:	eb 0b                	jmp    3828 <printint+0x36>
  neg = 0;
    381d:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
    3824:	eb f0                	jmp    3816 <printint+0x24>
  do{
    buf[i++] = digits[x % base];
    3826:	89 c6                	mov    %eax,%esi
    3828:	89 d0                	mov    %edx,%eax
    382a:	ba 00 00 00 00       	mov    $0x0,%edx
    382f:	f7 f1                	div    %ecx
    3831:	89 c3                	mov    %eax,%ebx
    3833:	8d 46 01             	lea    0x1(%esi),%eax
    3836:	0f b6 92 cc 52 00 00 	movzbl 0x52cc(%edx),%edx
    383d:	88 54 35 d8          	mov    %dl,-0x28(%ebp,%esi,1)
  }while((x /= base) != 0);
    3841:	89 da                	mov    %ebx,%edx
    3843:	85 db                	test   %ebx,%ebx
    3845:	75 df                	jne    3826 <printint+0x34>
    3847:	89 c3                	mov    %eax,%ebx
  if(neg)
    3849:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
    384d:	74 16                	je     3865 <printint+0x73>
    buf[i++] = '-';
    384f:	c6 44 05 d8 2d       	movb   $0x2d,-0x28(%ebp,%eax,1)
    3854:	8d 5e 02             	lea    0x2(%esi),%ebx
    3857:	eb 0c                	jmp    3865 <printint+0x73>

  while(--i >= 0)
    putc(fd, buf[i]);
    3859:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
    385e:	89 f8                	mov    %edi,%eax
    3860:	e8 73 ff ff ff       	call   37d8 <putc>
  while(--i >= 0)
    3865:	83 eb 01             	sub    $0x1,%ebx
    3868:	79 ef                	jns    3859 <printint+0x67>
}
    386a:	83 c4 2c             	add    $0x2c,%esp
    386d:	5b                   	pop    %ebx
    386e:	5e                   	pop    %esi
    386f:	5f                   	pop    %edi
    3870:	5d                   	pop    %ebp
...
printf(int fd, const char *fmt, ...)
{
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
    387b:	8d 45 10             	lea    0x10(%ebp),%eax
    387e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
    3881:	be 00 00 00 00       	mov    $0x0,%esi
  for(i = 0; fmt[i]; i++){
    3886:	bb 00 00 00 00       	mov    $0x0,%ebx
    388b:	eb 14                	jmp    38a1 <printf+0x2f>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
        ...
        putc(fd, c);
    388d:	89 fa                	mov    %edi,%edx
    388f:	8b 45 08             	mov    0x8(%ebp),%eax
    3892:	e8 41 ff ff ff       	call   37d8 <putc>
    3897:	eb 05                	jmp    389e <printf+0x2c>
      }
    } else if(state == '%'){
    3899:	83 fe 25             	cmp    $0x25,%esi
    389c:	74 25                	je     38c3 <printf+0x51>
  for(i = 0; fmt[i]; i++){
    389e:	83 c3 01             	add    $0x1,%ebx
    38a1:	8b 45 0c             	mov    0xc(%ebp),%eax
    38a4:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
    38a8:	84 c0                	test   %al,%al
    38aa:	0f 84 23 01 00 00    	je     39d3 <printf+0x161>
    c = fmt[i] & 0xff;
    38b0:	0f be f8             	movsbl %al,%edi
    38b3:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
    38b6:	85 f6                	test   %esi,%esi
    38b8:	75 df                	jne    3899 <printf+0x27>
      if(c == '%'){
    38ba:	83 f8 25             	cmp    $0x25,%eax
    38bd:	75 ce                	jne    388d <printf+0x1b>
        state = '%';
    38bf:	89 c6                	mov    %eax,%esi
    38c1:	eb db                	jmp    389e <printf+0x2c>
      if(c == 'd'){
    38c3:	83 f8 64             	cmp    $0x64,%eax
    38c6:	74 49                	je     3911 <printf+0x9f>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    38c8:	83 f8 78             	cmp    $0x78,%eax
    38cb:	0f 94 c1             	sete   %cl
    38ce:	83 f8 70             	cmp    $0x70,%eax
    38d1:	0f 94 c2             	sete   %dl
    38d4:	08 d1                	or     %dl,%cl
    38d6:	75 63                	jne    393b <printf+0xc9>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    38d8:	83 f8 73             	cmp    $0x73,%eax
    38db:	0f 84 84 00 00 00    	je     3965 <printf+0xf3>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    38e1:	83 f8 63             	cmp    $0x63,%eax
    38e4:	0f 84 b7 00 00 00    	je     39a1 <printf+0x12f>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    38ea:	83 f8 25             	cmp    $0x25,%eax
    38ed:	0f 84 cc 00 00 00    	je     39bf <printf+0x14d>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    38f3:	ba 25 00 00 00       	mov    $0x25,%edx
    38f8:	8b 45 08             	mov    0x8(%ebp),%eax
    38fb:	e8 d8 fe ff ff       	call   37d8 <putc>
        putc(fd, c);
    3900:	89 fa                	mov    %edi,%edx
    3902:	8b 45 08             	mov    0x8(%ebp),%eax
    3905:	e8 ce fe ff ff       	call   37d8 <putc>
      }
      state = 0;
    390a:	be 00 00 00 00       	mov    $0x0,%esi
    390f:	eb 8d                	jmp    389e <printf+0x2c>
        printint(fd, *ap, 10, 1);
    ...
    3923:	e8 ca fe ff ff       	call   37f2 <printint>
        ap++;
    ...
    3936:	e9 63 ff ff ff       	jmp    389e <printf+0x2c>
        printint(fd, *ap, 16, 0);
    393b:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    393e:	8b 17                	mov    (%edi),%edx
    3940:	83 ec 0c             	sub    $0xc,%esp
    3943:	6a 00                	push   $0x0
    3945:	b9 10 00 00 00       	mov    $0x10,%ecx
    394a:	8b 45 08             	mov    0x8(%ebp),%eax
    394d:	e8 a0 fe ff ff       	call   37f2 <printint>
        ap++;
    3952:	83 c7 04             	add    $0x4,%edi
    3955:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    3958:	83 c4 10             	add    $0x10,%esp
      state = 0;
    395b:	be 00 00 00 00       	mov    $0x0,%esi
    3960:	e9 39 ff ff ff       	jmp    389e <printf+0x2c>
        s = (char*)*ap;
    3965:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3968:	8b 30                	mov    (%eax),%esi
        ap++;
    396a:	83 c0 04             	add    $0x4,%eax
    396d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
    3970:	85 f6                	test   %esi,%esi
    3972:	75 28                	jne    399c <printf+0x12a>
          s = "(null)";
    3974:	be c4 52 00 00       	mov    $0x52c4,%esi
    3979:	8b 7d 08             	mov    0x8(%ebp),%edi
    397c:	eb 0d                	jmp    398b <printf+0x119>
          putc(fd, *s);
    397e:	0f be d2             	movsbl %dl,%edx
    3981:	89 f8                	mov    %edi,%eax
    3983:	e8 50 fe ff ff       	call   37d8 <putc>
          s++;
    3988:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
    398b:	0f b6 16             	movzbl (%esi),%edx
    398e:	84 d2                	test   %dl,%dl
    3990:	75 ec                	jne    397e <printf+0x10c>
      state = 0;
    3992:	be 00 00 00 00       	mov    $0x0,%esi
    3997:	e9 02 ff ff ff       	jmp    389e <printf+0x2c>
    399c:	8b 7d 08             	mov    0x8(%ebp),%edi
    399f:	eb ea                	jmp    398b <printf+0x119>
        putc(fd, *ap);
    39a1:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    39a4:	0f be 17             	movsbl (%edi),%edx
    39a7:	8b 45 08             	mov    0x8(%ebp),%eax
    39aa:	e8 29 fe ff ff       	call   37d8 <putc>
        ap++;
    39af:	83 c7 04             	add    $0x4,%edi
    39b2:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
    39b5:	be 00 00 00 00       	mov    $0x0,%esi
    39ba:	e9 df fe ff ff       	jmp    389e <printf+0x2c>
        putc(fd, c);
    39bf:	89 fa                	mov    %edi,%edx
    39c1:	8b 45 08             	mov    0x8(%ebp),%eax
    39c4:	e8 0f fe ff ff       	call   37d8 <putc>
      state = 0;
    39c9:	be 00 00 00 00       	mov    $0x0,%esi
    39ce:	e9 cb fe ff ff       	jmp    389e <printf+0x2c>
    }
  }
}
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    39e7:	a1 20 5c 00 00       	mov    0x5c20,%eax
  ...
  freep = p;
    3a25:	a3 20 5c 00 00       	mov    %eax,0x5c20
}
    3a2a:	5b                   	pop    %ebx
    3a2b:	5e                   	pop    %esi
    3a2c:	5f                   	pop    %edi
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3a6a:	50                   	push   %eax
    3a6b:	e8 38 fd ff ff       	call   37a8 <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    3a87:	a1 20 5c 00 00       	mov    0x5c20,%eax
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3aae:	8b 0d 20 5c 00 00    	mov    0x5c20,%ecx
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3aba:	eb 4d                	jmp    3b09 <malloc+0x6e>
    base.s.ptr = freep = prevp = &base;
    3abc:	c7 05 20 5c 00 00 24 	movl   $0x5c24,0x5c20
    3ac3:	5c 00 00 
    3ac6:	c7 05 24 5c 00 00 24 	movl   $0x5c24,0x5c24
    3acd:	5c 00 00 
    base.s.size = 0;
    3ad0:	c7 05 28 5c 00 00 00 	movl   $0x0,0x5c28
    3ad7:	00 00 00 
    base.s.ptr = freep = prevp = &base;
    3ada:	b9 24 5c 00 00       	mov    $0x5c24,%ecx
    3adf:	eb d7                	jmp    3ab8 <malloc+0x1d>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
    3ae1:	39 da                	cmp    %ebx,%edx
    3ae3:	74 1a                	je     3aff <malloc+0x64>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
    3ae5:	29 da                	sub    %ebx,%edx
    3ae7:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    3aea:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
    3aed:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
    3af0:	89 0d 20 5c 00 00    	mov    %ecx,0x5c20
      return (void*)(p + 1);
    3af6:	83 c0 08             	add    $0x8,%eax
    }
    if(p == freep)
    ...
    3af9:	83 c4 04             	add    $0x4,%esp
    3afc:	5b                   	pop    %ebx
    3afd:	5d                   	pop    %ebp
    3afe:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
    3aff:	8b 10                	mov    (%eax),%edx
    3b01:	89 11                	mov    %edx,(%ecx)
    3b03:	eb eb                	jmp    3af0 <malloc+0x55>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3b05:	89 c1                	mov    %eax,%ecx
    3b07:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
    3b09:	8b 50 04             	mov    0x4(%eax),%edx
    3b0c:	39 da                	cmp    %ebx,%edx
    3b0e:	73 d1                	jae    3ae1 <malloc+0x46>
    if(p == freep)
    3b10:	39 05 20 5c 00 00    	cmp    %eax,0x5c20
    3b16:	75 ed                	jne    3b05 <malloc+0x6a>
      if((p = morecore(nunits)) == 0)
    3b18:	89 d8                	mov    %ebx,%eax
    3b1a:	e8 2c ff ff ff       	call   3a4b <morecore>
    3b1f:	85 c0                	test   %eax,%eax
    3b21:	75 e2                	jne    3b05 <malloc+0x6a>
        return 0;
    3b23:	b8 00 00 00 00       	mov    $0x0,%eax
    3b28:	eb cf                	jmp    3af9 <malloc+0x5e>
