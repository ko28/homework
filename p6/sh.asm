...
runcmd(struct cmd *cmd)
{
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      71:	6a 02                	push   $0x2
      73:	e8 e0 0f 00 00       	call   1058 <printf>
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      c4:	6a 02                	push   $0x2
      c6:	e8 8d 0f 00 00       	call   1058 <printf>
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     ...
     259:	6a 02                	push   $0x2
     25b:	e8 f8 0d 00 00       	call   1058 <printf>
...
main(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     347:	6a 02                	push   $0x2
     349:	e8 0a 0d 00 00       	call   1058 <printf>
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     3a8:	68 6d 14 00 00       	push   $0x146d
     3ad:	6a 02                	push   $0x2
     3af:	e8 a4 0c 00 00       	call   1058 <printf>
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     3d3:	68 71 14 00 00       	push   $0x1471
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ee:	6a 54                	push   $0x54
     3f0:	e8 36 0f 00 00       	call   132b <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     424:	6a 18                	push   $0x18
     426:	e8 00 0f 00 00       	call   132b <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     487:	6a 0c                	push   $0xc
     489:	e8 9d 0e 00 00       	call   132b <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4cf:	6a 0c                	push   $0xc
     4d1:	e8 55 0e 00 00       	call   132b <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     517:	6a 08                	push   $0x8
     519:	e8 0d 0e 00 00       	call   132b <malloc>
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     74a:	68 76 14 00 00       	push   $0x1476
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     76c:	50                   	push   %eax
     76d:	68 77 14 00 00       	push   $0x1477
     772:	6a 02                	push   $0x2
     774:	e8 df 08 00 00       	call   1058 <printf>
     779:	83 c4 10             	add    $0x10,%esp
    panic("syntax");
     77c:	83 ec 0c             	sub    $0xc,%esp
     77f:	68 86 14 00 00       	push   $0x1486
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     7e4:	68 8d 14 00 00       	push   $0x148d
  ...
  if(peek(ps, es, ";")){
     ...
     7fe:	68 8f 14 00 00       	push   $0x148f
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     86c:	68 91 14 00 00       	push   $0x1491
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     8fb:	68 93 14 00 00       	push   $0x1493
  ...
  while(peek(ps, es, "<>")){
     ...
     981:	68 b0 14 00 00       	push   $0x14b0
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     9aa:	68 b3 14 00 00       	push   $0x14b3
    ...
    panic("parseblock");
     ...
     9c4:	68 b5 14 00 00       	push   $0x14b5
  ...
  if(!peek(ps, es, ")"))
     ...
     9fa:	68 c0 14 00 00       	push   $0x14c0
    ...
    panic("syntax - missing )");
     ...
     a14:	68 c2 14 00 00       	push   $0x14c2
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     a58:	68 b3 14 00 00       	push   $0x14b3
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     ae2:	68 86 14 00 00       	push   $0x1486
    ...
    if(argc >= MAXARGS)
     ...
     b19:	68 d5 14 00 00       	push   $0x14d5
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     b40:	68 e3 14 00 00       	push   $0x14e3
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ba6:	8b 04 85 e8 14 00 00 	mov    0x14e8(,%eax,4),%eax
     bad:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
     fae:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
     fb5:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
     fb9:	74 17                	je     fd2 <printint+0x2a>
     fbb:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
     fbf:	79 11                	jns    fd2 <printint+0x2a>
    neg = 1;
     fc1:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
     fc8:	8b 45 0c             	mov    0xc(%ebp),%eax
     fcb:	f7 d8                	neg    %eax
     fcd:	89 45 ec             	mov    %eax,-0x14(%ebp)
     fd0:	eb 06                	jmp    fd8 <printint+0x30>
  } else {
    x = xx;
  ...
  i = 0;
     fd8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
     fdf:	8b 4d 10             	mov    0x10(%ebp),%ecx
     fe2:	8b 45 ec             	mov    -0x14(%ebp),%eax
     fe5:	ba 00 00 00 00       	mov    $0x0,%edx
     fea:	f7 f1                	div    %ecx
     fec:	89 d1                	mov    %edx,%ecx
     fee:	8b 45 f4             	mov    -0xc(%ebp),%eax
     ff1:	8d 50 01             	lea    0x1(%eax),%edx
     ff4:	89 55 f4             	mov    %edx,-0xc(%ebp)
     ff7:	0f b6 91 98 19 00 00 	movzbl 0x1998(%ecx),%edx
     ffe:	88 54 05 dc          	mov    %dl,-0x24(%ebp,%eax,1)
  }while((x /= base) != 0);
    1002:	8b 4d 10             	mov    0x10(%ebp),%ecx
    1005:	8b 45 ec             	mov    -0x14(%ebp),%eax
    1008:	ba 00 00 00 00       	mov    $0x0,%edx
    100d:	f7 f1                	div    %ecx
    100f:	89 45 ec             	mov    %eax,-0x14(%ebp)
    1012:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1016:	75 c7                	jne    fdf <printint+0x37>
  if(neg)
    1018:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    101c:	74 2d                	je     104b <printint+0xa3>
    buf[i++] = '-';
    101e:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1021:	8d 50 01             	lea    0x1(%eax),%edx
    1024:	89 55 f4             	mov    %edx,-0xc(%ebp)
    1027:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    102c:	eb 1d                	jmp    104b <printint+0xa3>
    putc(fd, buf[i]);
    102e:	8d 55 dc             	lea    -0x24(%ebp),%edx
    ...
    1043:	e8 3d ff ff ff       	call   f85 <putc>
    1048:	83 c4 10             	add    $0x10,%esp
  while(--i >= 0)
    104b:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    104f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1053:	79 d9                	jns    102e <printint+0x86>
}
    1055:	90                   	nop
    1056:	c9                   	leave  
    1057:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
  ...
  state = 0;
    105e:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    1065:	8d 45 0c             	lea    0xc(%ebp),%eax
    1068:	83 c0 04             	add    $0x4,%eax
    106b:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    106e:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    1075:	e9 59 01 00 00       	jmp    11d3 <printf+0x17b>
    c = fmt[i] & 0xff;
    107a:	8b 55 0c             	mov    0xc(%ebp),%edx
    107d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1080:	01 d0                	add    %edx,%eax
    1082:	0f b6 00             	movzbl (%eax),%eax
    1085:	0f be c0             	movsbl %al,%eax
    1088:	25 ff 00 00 00       	and    $0xff,%eax
    108d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    1090:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1094:	75 2c                	jne    10c2 <printf+0x6a>
      if(c == '%'){
    1096:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    109a:	75 0c                	jne    10a8 <printf+0x50>
        state = '%';
    109c:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    10a3:	e9 27 01 00 00       	jmp    11cf <printf+0x177>
      } else {
        putc(fd, c);
    10a8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    10ab:	0f be c0             	movsbl %al,%eax
    10ae:	83 ec 08             	sub    $0x8,%esp
    10b1:	50                   	push   %eax
    10b2:	ff 75 08             	pushl  0x8(%ebp)
    10b5:	e8 cb fe ff ff       	call   f85 <putc>
    10ba:	83 c4 10             	add    $0x10,%esp
    10bd:	e9 0d 01 00 00       	jmp    11cf <printf+0x177>
      }
    } else if(state == '%'){
    10c2:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    10c6:	0f 85 03 01 00 00    	jne    11cf <printf+0x177>
      if(c == 'd'){
    10cc:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    10d0:	75 1e                	jne    10f0 <printf+0x98>
        printint(fd, *ap, 10, 1);
    ...
    10df:	e8 c4 fe ff ff       	call   fa8 <printint>
    10e4:	83 c4 10             	add    $0x10,%esp
        ap++;
    10e7:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    10eb:	e9 d8 00 00 00       	jmp    11c8 <printf+0x170>
      } else if(c == 'x' || c == 'p'){
    10f0:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    10f4:	74 06                	je     10fc <printf+0xa4>
    10f6:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    10fa:	75 1e                	jne    111a <printf+0xc2>
        printint(fd, *ap, 16, 0);
    10fc:	8b 45 e8             	mov    -0x18(%ebp),%eax
    10ff:	8b 00                	mov    (%eax),%eax
    1101:	6a 00                	push   $0x0
    1103:	6a 10                	push   $0x10
    1105:	50                   	push   %eax
    1106:	ff 75 08             	pushl  0x8(%ebp)
    1109:	e8 9a fe ff ff       	call   fa8 <printint>
    110e:	83 c4 10             	add    $0x10,%esp
        ap++;
    1111:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1115:	e9 ae 00 00 00       	jmp    11c8 <printf+0x170>
      } else if(c == 's'){
    111a:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    111e:	75 43                	jne    1163 <printf+0x10b>
        s = (char*)*ap;
    ...
    1128:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    112c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1130:	75 25                	jne    1157 <printf+0xff>
          s = "(null)";
    1132:	c7 45 f4 00 15 00 00 	movl   $0x1500,-0xc(%ebp)
        while(*s != 0){
    1139:	eb 1c                	jmp    1157 <printf+0xff>
          putc(fd, *s);
    113b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    113e:	0f b6 00             	movzbl (%eax),%eax
    1141:	0f be c0             	movsbl %al,%eax
    1144:	83 ec 08             	sub    $0x8,%esp
    1147:	50                   	push   %eax
    1148:	ff 75 08             	pushl  0x8(%ebp)
    114b:	e8 35 fe ff ff       	call   f85 <putc>
    1150:	83 c4 10             	add    $0x10,%esp
          s++;
    1153:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
        while(*s != 0){
    1157:	8b 45 f4             	mov    -0xc(%ebp),%eax
    115a:	0f b6 00             	movzbl (%eax),%eax
    115d:	84 c0                	test   %al,%al
    115f:	75 da                	jne    113b <printf+0xe3>
    1161:	eb 65                	jmp    11c8 <printf+0x170>
        }
      } else if(c == 'c'){
    1163:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    1167:	75 1d                	jne    1186 <printf+0x12e>
        putc(fd, *ap);
    1169:	8b 45 e8             	mov    -0x18(%ebp),%eax
    116c:	8b 00                	mov    (%eax),%eax
    116e:	0f be c0             	movsbl %al,%eax
    1171:	83 ec 08             	sub    $0x8,%esp
    1174:	50                   	push   %eax
    1175:	ff 75 08             	pushl  0x8(%ebp)
    1178:	e8 08 fe ff ff       	call   f85 <putc>
    117d:	83 c4 10             	add    $0x10,%esp
        ap++;
    1180:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1184:	eb 42                	jmp    11c8 <printf+0x170>
      } else if(c == '%'){
    1186:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    118a:	75 17                	jne    11a3 <printf+0x14b>
        putc(fd, c);
    118c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    118f:	0f be c0             	movsbl %al,%eax
    1192:	83 ec 08             	sub    $0x8,%esp
    1195:	50                   	push   %eax
    1196:	ff 75 08             	pushl  0x8(%ebp)
    1199:	e8 e7 fd ff ff       	call   f85 <putc>
    119e:	83 c4 10             	add    $0x10,%esp
    11a1:	eb 25                	jmp    11c8 <printf+0x170>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    11a3:	83 ec 08             	sub    $0x8,%esp
    11a6:	6a 25                	push   $0x25
    11a8:	ff 75 08             	pushl  0x8(%ebp)
    11ab:	e8 d5 fd ff ff       	call   f85 <putc>
    ...
    11c0:	e8 c0 fd ff ff       	call   f85 <putc>
    11c5:	83 c4 10             	add    $0x10,%esp
      }
      state = 0;
    11c8:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  for(i = 0; fmt[i]; i++){
    11cf:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    11d3:	8b 55 0c             	mov    0xc(%ebp),%edx
    11d6:	8b 45 f0             	mov    -0x10(%ebp),%eax
    11d9:	01 d0                	add    %edx,%eax
    11db:	0f b6 00             	movzbl (%eax),%eax
    11de:	84 c0                	test   %al,%al
    11e0:	0f 85 94 fe ff ff    	jne    107a <printf+0x22>
    }
  }
}
    11e6:	90                   	nop
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    120f:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    1212:	77 24                	ja     1238 <free+0x4f>
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1229:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    122c:	76 d4                	jbe    1202 <free+0x19>
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12ea:	50                   	push   %eax
    12eb:	e8 6d fc ff ff       	call   f5d <sbrk>
...
malloc(uint nbytes)
{
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    137f:	39 45 ec             	cmp    %eax,-0x14(%ebp)
    1382:	77 4d                	ja     13d1 <malloc+0xa6>
      if(p->s.size == nunits)
