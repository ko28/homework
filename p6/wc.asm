...
wc(int fd, char *name)
{
  ...
  b9:	68 53 09 00 00       	push   $0x953
  be:	6a 01                	push   $0x1
  c0:	e8 d2 04 00 00       	call   597 <printf>
  ...
  dc:	68 63 09 00 00       	push   $0x963
  e1:	6a 01                	push   $0x1
  e3:	e8 af 04 00 00       	call   597 <printf>
...
main(int argc, char *argv[])
{
 ...
 16c:	6a 01                	push   $0x1
 16e:	e8 24 04 00 00       	call   597 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 536:	0f b6 91 f4 0b 00 00 	movzbl 0xbf4(%ecx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	e9 59 01 00 00       	jmp    712 <printf+0x17b>
    c = fmt[i] & 0xff;
 ...
 5e2:	e9 27 01 00 00       	jmp    70e <printf+0x177>
      } else {
        putc(fd, c);
 ...
 5f4:	e8 cb fe ff ff       	call   4c4 <putc>
 5f9:	83 c4 10             	add    $0x10,%esp
 5fc:	e9 0d 01 00 00       	jmp    70e <printf+0x177>
      }
    } else if(state == '%'){
 601:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 605:	0f 85 03 01 00 00    	jne    70e <printf+0x177>
      if(c == 'd'){
 60b:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 60f:	75 1e                	jne    62f <printf+0x98>
        printint(fd, *ap, 10, 1);
 ...
 61e:	e8 c4 fe ff ff       	call   4e7 <printint>
 623:	83 c4 10             	add    $0x10,%esp
        ap++;
 626:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 62a:	e9 d8 00 00 00       	jmp    707 <printf+0x170>
      } else if(c == 'x' || c == 'p'){
 62f:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 633:	74 06                	je     63b <printf+0xa4>
 635:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 639:	75 1e                	jne    659 <printf+0xc2>
        printint(fd, *ap, 16, 0);
 ...
 648:	e8 9a fe ff ff       	call   4e7 <printint>
 64d:	83 c4 10             	add    $0x10,%esp
        ap++;
 650:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 654:	e9 ae 00 00 00       	jmp    707 <printf+0x170>
      } else if(c == 's'){
 659:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 65d:	75 43                	jne    6a2 <printf+0x10b>
        s = (char*)*ap;
 ...
 66f:	75 25                	jne    696 <printf+0xff>
          s = "(null)";
 671:	c7 45 f4 85 09 00 00 	movl   $0x985,-0xc(%ebp)
        while(*s != 0){
 678:	eb 1c                	jmp    696 <printf+0xff>
          putc(fd, *s);
 ...
 68a:	e8 35 fe ff ff       	call   4c4 <putc>
 ...
 69e:	75 da                	jne    67a <printf+0xe3>
 6a0:	eb 65                	jmp    707 <printf+0x170>
        }
      } else if(c == 'c'){
 6a2:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 6a6:	75 1d                	jne    6c5 <printf+0x12e>
        putc(fd, *ap);
 ...
 6b7:	e8 08 fe ff ff       	call   4c4 <putc>
 6bc:	83 c4 10             	add    $0x10,%esp
        ap++;
 6bf:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 6c3:	eb 42                	jmp    707 <printf+0x170>
      } else if(c == '%'){
 6c5:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 6c9:	75 17                	jne    6e2 <printf+0x14b>
        putc(fd, c);
 ...
 6d8:	e8 e7 fd ff ff       	call   4c4 <putc>
 6dd:	83 c4 10             	add    $0x10,%esp
 6e0:	eb 25                	jmp    707 <printf+0x170>
      } else {
 ...
 6ea:	e8 d5 fd ff ff       	call   4c4 <putc>
 ...
 6ff:	e8 c0 fd ff ff       	call   4c4 <putc>
 ...
 71f:	0f 85 94 fe ff ff    	jne    5b9 <printf+0x22>
    }
  }
}
 725:	90                   	nop
...
free(void *ap)
{
 ...
 737:	a1 28 0c 00 00       	mov    0xc28,%eax
 73c:	89 45 fc             	mov    %eax,-0x4(%ebp)
 73f:	eb 24                	jmp    765 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 741:	8b 45 fc             	mov    -0x4(%ebp),%eax
 744:	8b 00                	mov    (%eax),%eax
 746:	39 45 fc             	cmp    %eax,-0x4(%ebp)
 749:	72 12                	jb     75d <free+0x35>
 ...
 802:	a3 28 0c 00 00       	mov    %eax,0xc28
}
 807:	90                   	nop
 808:	c9                   	leave  
 809:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 829:	50                   	push   %eax
 82a:	e8 6d fc ff ff       	call   49c <sbrk>
 ...
 860:	83 c4 10             	add    $0x10,%esp
  return freep;
 863:	a1 28 0c 00 00       	mov    0xc28,%eax
}
 868:	c9                   	leave  
 869:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 903:	a3 28 0c 00 00       	mov    %eax,0xc28
      return (void*)(p + 1);
 ...
 90e:	eb 3b                	jmp    94b <malloc+0xe1>
    ...
    if(p == freep)
 910:	a1 28 0c 00 00       	mov    0xc28,%eax
