...
000001d8 <main>:
{
 ...
 24f:	68 24 08 00 00       	push   $0x824
 254:	6a 02                	push   $0x2
 256:	e8 0f 03 00 00       	call   56a <printf>
    exit();
 ...
 273:	ff 37                	pushl  (%edi)
 275:	68 44 08 00 00       	push   $0x844
 27a:	6a 01                	push   $0x1
 27c:	e8 e9 02 00 00       	call   56a <printf>
      exit();
...
putc(int fd, char c)
{
 ...
 4de:	52                   	push   %edx
 4df:	50                   	push   %eax
 4e0:	e8 53 ff ff ff       	call   438 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4f9:	0f 95 c3             	setne  %bl
 4fc:	89 d0                	mov    %edx,%eax
 4fe:	c1 e8 1f             	shr    $0x1f,%eax
 501:	84 c3                	test   %al,%bl
 503:	74 10                	je     515 <printint+0x2b>
    neg = 1;
    x = -xx;
 505:	f7 da                	neg    %edx
    neg = 1;
 507:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }
 ...
 513:	eb 0b                	jmp    520 <printint+0x36>
  neg = 0;
 515:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
 51c:	eb f0                	jmp    50e <printint+0x24>
  do{
    buf[i++] = digits[x % base];
 ...
 52b:	8d 46 01             	lea    0x1(%esi),%eax
 52e:	0f b6 92 64 08 00 00 	movzbl 0x864(%edx),%edx
 535:	88 54 35 d8          	mov    %dl,-0x28(%ebp,%esi,1)
  }while((x /= base) != 0);
 539:	89 da                	mov    %ebx,%edx
 53b:	85 db                	test   %ebx,%ebx
 53d:	75 df                	jne    51e <printint+0x34>
 53f:	89 c3                	mov    %eax,%ebx
  if(neg)
 541:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
 545:	74 16                	je     55d <printint+0x73>
    buf[i++] = '-';
 547:	c6 44 05 d8 2d       	movb   $0x2d,-0x28(%ebp,%eax,1)
 54c:	8d 5e 02             	lea    0x2(%esi),%ebx
 54f:	eb 0c                	jmp    55d <printint+0x73>

  while(--i >= 0)
    putc(fd, buf[i]);
 551:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
 556:	89 f8                	mov    %edi,%eax
 558:	e8 73 ff ff ff       	call   4d0 <putc>
  while(--i >= 0)
 55d:	83 eb 01             	sub    $0x1,%ebx
 560:	79 ef                	jns    551 <printint+0x67>
}
...
printf(int fd, const char *fmt, ...)
{
 ...
 58a:	e8 41 ff ff ff       	call   4d0 <putc>
 ...
 5a2:	0f 84 23 01 00 00    	je     6cb <printf+0x161>
    c = fmt[i] & 0xff;
 ...
 5b9:	eb db                	jmp    596 <printf+0x2c>
      if(c == 'd'){
 5bb:	83 f8 64             	cmp    $0x64,%eax
 5be:	74 49                	je     609 <printf+0x9f>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
 5c0:	83 f8 78             	cmp    $0x78,%eax
 5c3:	0f 94 c1             	sete   %cl
 5c6:	83 f8 70             	cmp    $0x70,%eax
 5c9:	0f 94 c2             	sete   %dl
 5cc:	08 d1                	or     %dl,%cl
 5ce:	75 63                	jne    633 <printf+0xc9>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
 5d0:	83 f8 73             	cmp    $0x73,%eax
 5d3:	0f 84 84 00 00 00    	je     65d <printf+0xf3>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 5dc:	0f 84 b7 00 00 00    	je     699 <printf+0x12f>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 5e2:	83 f8 25             	cmp    $0x25,%eax
 5e5:	0f 84 cc 00 00 00    	je     6b7 <printf+0x14d>
        putc(fd, c);
      } else {
 ...
 5f3:	e8 d8 fe ff ff       	call   4d0 <putc>
        putc(fd, c);
 5f8:	89 fa                	mov    %edi,%edx
 5fa:	8b 45 08             	mov    0x8(%ebp),%eax
 5fd:	e8 ce fe ff ff       	call   4d0 <putc>
      }
      state = 0;
 602:	be 00 00 00 00       	mov    $0x0,%esi
 607:	eb 8d                	jmp    596 <printf+0x2c>
        printint(fd, *ap, 10, 1);
 ...
 61b:	e8 ca fe ff ff       	call   4ea <printint>
        ap++;
 ...
 62e:	e9 63 ff ff ff       	jmp    596 <printf+0x2c>
        printint(fd, *ap, 16, 0);
 ...
 645:	e8 a0 fe ff ff       	call   4ea <printint>
        ap++;
 ...
 658:	e9 39 ff ff ff       	jmp    596 <printf+0x2c>
        s = (char*)*ap;
 ...
 66a:	75 28                	jne    694 <printf+0x12a>
          s = "(null)";
 66c:	be 5a 08 00 00       	mov    $0x85a,%esi
 671:	8b 7d 08             	mov    0x8(%ebp),%edi
 674:	eb 0d                	jmp    683 <printf+0x119>
          putc(fd, *s);
 676:	0f be d2             	movsbl %dl,%edx
 679:	89 f8                	mov    %edi,%eax
 67b:	e8 50 fe ff ff       	call   4d0 <putc>
          s++;
 680:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
 683:	0f b6 16             	movzbl (%esi),%edx
 686:	84 d2                	test   %dl,%dl
 688:	75 ec                	jne    676 <printf+0x10c>
      state = 0;
 68a:	be 00 00 00 00       	mov    $0x0,%esi
 68f:	e9 02 ff ff ff       	jmp    596 <printf+0x2c>
 694:	8b 7d 08             	mov    0x8(%ebp),%edi
 697:	eb ea                	jmp    683 <printf+0x119>
        putc(fd, *ap);
 699:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 69c:	0f be 17             	movsbl (%edi),%edx
 69f:	8b 45 08             	mov    0x8(%ebp),%eax
 6a2:	e8 29 fe ff ff       	call   4d0 <putc>
        ap++;
 6a7:	83 c7 04             	add    $0x4,%edi
 6aa:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
 6ad:	be 00 00 00 00       	mov    $0x0,%esi
 6b2:	e9 df fe ff ff       	jmp    596 <printf+0x2c>
        putc(fd, c);
 ...
 6c6:	e9 cb fe ff ff       	jmp    596 <printf+0x2c>
    }
  }
}
...
free(void *ap)
{
 ...
 6d9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  bp = (Header*)ap - 1;
 6dc:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 6df:	a1 c0 0b 00 00       	mov    0xbc0,%eax
 6e4:	eb 02                	jmp    6e8 <free+0x15>
 6e6:	89 d0                	mov    %edx,%eax
 6e8:	39 c8                	cmp    %ecx,%eax
 6ea:	73 04                	jae    6f0 <free+0x1d>
 6ec:	39 08                	cmp    %ecx,(%eax)
 6ee:	77 12                	ja     702 <free+0x2f>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 6f0:	8b 10                	mov    (%eax),%edx
 6f2:	39 c2                	cmp    %eax,%edx
 6f4:	77 f0                	ja     6e6 <free+0x13>
 6f6:	39 c8                	cmp    %ecx,%eax
 6f8:	72 08                	jb     702 <free+0x2f>
 6fa:	39 ca                	cmp    %ecx,%edx
 6fc:	77 04                	ja     702 <free+0x2f>
 6fe:	89 d0                	mov    %edx,%eax
 700:	eb e6                	jmp    6e8 <free+0x15>
      break;
  if(bp + bp->s.size == p->s.ptr){
 702:	8b 73 fc             	mov    -0x4(%ebx),%esi
 705:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
 708:	8b 10                	mov    (%eax),%edx
 70a:	39 d7                	cmp    %edx,%edi
 70c:	74 19                	je     727 <free+0x54>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
 70e:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
 711:	8b 50 04             	mov    0x4(%eax),%edx
 714:	8d 34 d0             	lea    (%eax,%edx,8),%esi
 717:	39 ce                	cmp    %ecx,%esi
 719:	74 1b                	je     736 <free+0x63>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
 71b:	89 08                	mov    %ecx,(%eax)
  freep = p;
 71d:	a3 c0 0b 00 00       	mov    %eax,0xbc0
}
 722:	5b                   	pop    %ebx
 723:	5e                   	pop    %esi
 724:	5f                   	pop    %edi
 ...
 726:	c3                   	ret    
    bp->s.size += p->s.ptr->s.size;
 727:	03 72 04             	add    0x4(%edx),%esi
 72a:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
 72d:	8b 10                	mov    (%eax),%edx
 72f:	8b 12                	mov    (%edx),%edx
 731:	89 53 f8             	mov    %edx,-0x8(%ebx)
 734:	eb db                	jmp    711 <free+0x3e>
    p->s.size += bp->s.size;
 736:	03 53 fc             	add    -0x4(%ebx),%edx
 739:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
 73c:	8b 53 f8             	mov    -0x8(%ebx),%edx
 73f:	89 10                	mov    %edx,(%eax)
 741:	eb da                	jmp    71d <free+0x4a>
...
morecore(uint nu)
{
 ...
 74a:	89 c3                	mov    %eax,%ebx
  char *p;
  Header *hp;

  if(nu < 4096)
 74c:	3d ff 0f 00 00       	cmp    $0xfff,%eax
 751:	77 05                	ja     758 <morecore+0x15>
    nu = 4096;
 753:	bb 00 10 00 00       	mov    $0x1000,%ebx
  p = sbrk(nu * sizeof(Header));
 758:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
 75f:	83 ec 0c             	sub    $0xc,%esp
 762:	50                   	push   %eax
 763:	e8 38 fd ff ff       	call   4a0 <sbrk>
  if(p == (char*)-1)
 768:	83 c4 10             	add    $0x10,%esp
 76b:	83 f8 ff             	cmp    $0xffffffff,%eax
 76e:	74 1c                	je     78c <morecore+0x49>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 ...
 779:	50                   	push   %eax
 77a:	e8 54 ff ff ff       	call   6d3 <free>
  return freep;
 77f:	a1 c0 0b 00 00       	mov    0xbc0,%eax
 ...
 791:	eb f4                	jmp    787 <morecore+0x44>
...
malloc(uint nbytes)
{
 ...
 796:	53                   	push   %ebx
 797:	83 ec 04             	sub    $0x4,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 79a:	8b 45 08             	mov    0x8(%ebp),%eax
 79d:	8d 58 07             	lea    0x7(%eax),%ebx
 7a0:	c1 eb 03             	shr    $0x3,%ebx
 7a3:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 7a6:	8b 0d c0 0b 00 00    	mov    0xbc0,%ecx
 7ac:	85 c9                	test   %ecx,%ecx
 7ae:	74 04                	je     7b4 <malloc+0x21>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b0:	8b 01                	mov    (%ecx),%eax
 7b2:	eb 4d                	jmp    801 <malloc+0x6e>
    base.s.ptr = freep = prevp = &base;
 7b4:	c7 05 c0 0b 00 00 c4 	movl   $0xbc4,0xbc0
 7bb:	0b 00 00 
 7be:	c7 05 c4 0b 00 00 c4 	movl   $0xbc4,0xbc4
 7c5:	0b 00 00 
    base.s.size = 0;
 7c8:	c7 05 c8 0b 00 00 00 	movl   $0x0,0xbc8
 7cf:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 7d2:	b9 c4 0b 00 00       	mov    $0xbc4,%ecx
 7d7:	eb d7                	jmp    7b0 <malloc+0x1d>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
 7d9:	39 da                	cmp    %ebx,%edx
 7db:	74 1a                	je     7f7 <malloc+0x64>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
 ...
 7e5:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 7e8:	89 0d c0 0b 00 00    	mov    %ecx,0xbc0
      return (void*)(p + 1);
 ...
 806:	73 d1                	jae    7d9 <malloc+0x46>
    if(p == freep)
 808:	39 05 c0 0b 00 00    	cmp    %eax,0xbc0
 80e:	75 ed                	jne    7fd <malloc+0x6a>
      if((p = morecore(nunits)) == 0)
 810:	89 d8                	mov    %ebx,%eax
 812:	e8 2c ff ff ff       	call   743 <morecore>
 817:	85 c0                	test   %eax,%eax
 819:	75 e2                	jne    7fd <malloc+0x6a>
        return 0;
 81b:	b8 00 00 00 00       	mov    $0x0,%eax
 820:	eb cf                	jmp    7f1 <malloc+0x5e>
