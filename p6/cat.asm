...
cat(int fd)
{
  ...
  25:	68 bb 08 00 00       	push   $0x8bb
  2a:	6a 01                	push   $0x1
  2c:	e8 d4 04 00 00       	call   505 <printf>
  ...
  63:	68 cd 08 00 00       	push   $0x8cd
  68:	6a 01                	push   $0x1
  6a:	e8 96 04 00 00       	call   505 <printf>
...
main(int argc, char *argv[])
{
  ...
  ea:	50                   	push   %eax
  eb:	68 de 08 00 00       	push   $0x8de
  f0:	6a 01                	push   $0x1
  f2:	e8 0e 04 00 00       	call   505 <printf>
...
printf(int fd, const char *fmt, ...)
{
 ...
 562:	e8 cb fe ff ff       	call   432 <putc>
 ...
 58c:	e8 c4 fe ff ff       	call   455 <printint>
 ...
 5b6:	e8 9a fe ff ff       	call   455 <printint>
 ...
 5dd:	75 25                	jne    604 <printf+0xff>
          s = "(null)";
 5df:	c7 45 f4 f3 08 00 00 	movl   $0x8f3,-0xc(%ebp)
        while(*s != 0){
 ...
 5f8:	e8 35 fe ff ff       	call   432 <putc>
 ...
 625:	e8 08 fe ff ff       	call   432 <putc>
 ...
 646:	e8 e7 fd ff ff       	call   432 <putc>
 ...
 658:	e8 d5 fd ff ff       	call   432 <putc>
 ...
 66d:	e8 c0 fd ff ff       	call   432 <putc>
...
free(void *ap)
{
 ...
 770:	a3 88 0b 00 00       	mov    %eax,0xb88
}
 775:	90                   	nop
 776:	c9                   	leave  
 777:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 797:	50                   	push   %eax
 798:	e8 6d fc ff ff       	call   40a <sbrk>
 ...
 7ce:	83 c4 10             	add    $0x10,%esp
  return freep;
 7d1:	a1 88 0b 00 00       	mov    0xb88,%eax
}
 7d6:	c9                   	leave  
 7d7:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7ea:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7ed:	a1 88 0b 00 00       	mov    0xb88,%eax
 7f2:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7f5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7f9:	75 23                	jne    81e <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7fb:	c7 45 f0 80 0b 00 00 	movl   $0xb80,-0x10(%ebp)
 802:	8b 45 f0             	mov    -0x10(%ebp),%eax
 805:	a3 88 0b 00 00       	mov    %eax,0xb88
 80a:	a1 88 0b 00 00       	mov    0xb88,%eax
 80f:	a3 80 0b 00 00       	mov    %eax,0xb80
    base.s.size = 0;
 814:	c7 05 84 0b 00 00 00 	movl   $0x0,0xb84
 81b:	00 00 00 
  }
 ...
 82f:	77 4d                	ja     87e <malloc+0xa6>
      if(p->s.size == nunits)
 831:	8b 45 f4             	mov    -0xc(%ebp),%eax
 834:	8b 40 04             	mov    0x4(%eax),%eax
 837:	39 45 ec             	cmp    %eax,-0x14(%ebp)
 ...
 871:	a3 88 0b 00 00       	mov    %eax,0xb88
      return (void*)(p + 1);
 ...
 87c:	eb 3b                	jmp    8b9 <malloc+0xe1>
    ...
    if(p == freep)
 87e:	a1 88 0b 00 00       	mov    0xb88,%eax
