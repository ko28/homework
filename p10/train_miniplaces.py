...
from student_code import SimpleConvNet, train_model, test_model, Net
...
def main(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_model(model, train_loader, optimizer, training_criterion, epoch, device)
        # evaluate the model on test_set after this epoch
        acc = test_model(model, test_loader, epoch, device)
