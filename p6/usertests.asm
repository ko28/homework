...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       6:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(mkdir("iputdir") < 0){
    ...
    printf(stdout, "mkdir failed\n");
      30:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(chdir("iputdir") < 0){
    ...
    printf(stdout, "chdir iputdir failed\n");
      5f:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(unlink("../iputdir") < 0){
    ...
    printf(stdout, "unlink ../iputdir failed\n");
      8e:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(chdir("/") < 0){
    ...
    printf(stdout, "chdir / failed\n");
      bd:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  printf(stdout, "iput test ok\n");
      d8:	a1 88 64 00 00       	mov    0x6488,%eax
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      f7:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     11b:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     152:	79 1b                	jns    16f <exitiputtest+0x7e>
      printf(stdout, "mkdir failed\n");
     154:	a1 88 64 00 00       	mov    0x6488,%eax
    ...
    if(chdir("iputdir") < 0){
     ...
     183:	a1 88 64 00 00       	mov    0x6488,%eax
    ...
    if(unlink("../iputdir") < 0){
     ...
     1b0:	79 1b                	jns    1cd <exitiputtest+0xdc>
      printf(stdout, "unlink ../iputdir failed\n");
     1b2:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  printf(stdout, "exitiput test ok\n");
     1d7:	a1 88 64 00 00       	mov    0x6488,%eax
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1f6:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(mkdir("oidir") < 0){
    ...
    printf(stdout, "mkdir oidir failed\n");
     220:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     249:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     285:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(unlink("oidir") != 0){
    ...
    printf(stdout, "unlink failed\n");
     2c6:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  printf(stdout, "openiput test ok\n");
     2e6:	a1 88 64 00 00       	mov    0x6488,%eax
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     305:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     336:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     37a:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  printf(stdout, "open test ok\n");
     395:	a1 88 64 00 00       	mov    0x6488,%eax
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     3b4:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     3e8:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     40a:	a1 88 64 00 00       	mov    0x6488,%eax
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     43f:	a1 88 64 00 00       	mov    0x6488,%eax
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     477:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  printf(stdout, "writes ok\n");
     49f:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     4de:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  i = read(fd, buf, 2000);
     ...
     4fc:	68 80 8c 00 00       	push   $0x8c80
  ...
  if(i == 2000){
    ...
    printf(stdout, "error: open small failed!\n");
     51a:	a1 88 64 00 00       	mov    0x6488,%eax
    ...
    printf(stdout, "read succeeded ok\n");
     535:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(unlink("small") < 0){
    ...
    printf(stdout, "read failed\n");
     56f:	a1 88 64 00 00       	mov    0x6488,%eax
    ...
    printf(stdout, "unlink small failed\n");
     58a:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  printf(stdout, "small file test ok\n");
     5a5:	a1 88 64 00 00       	mov    0x6488,%eax
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     5c4:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     5f8:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     645:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     69a:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     6c4:	68 80 8c 00 00       	push   $0x8c80
    ...
    if(i == 0){
     ...
     6e6:	a1 88 64 00 00       	mov    0x6488,%eax
     ...
     70d:	a1 88 64 00 00       	mov    0x6488,%eax
    ...
    if(((int*)buf)[0] != n){
     72b:	b8 80 8c 00 00       	mov    $0x8c80,%eax
     730:	8b 00                	mov    (%eax),%eax
     732:	39 45 f0             	cmp    %eax,-0x10(%ebp)
     735:	74 23                	je     75a <writetest1+0x19c>
      printf(stdout, "read content of block %d is %d\n",
             n, ((int*)buf)[0]);
     737:	b8 80 8c 00 00       	mov    $0x8c80,%eax
      printf(stdout, "read content of block %d is %d\n",
     73c:	8b 10                	mov    (%eax),%edx
     73e:	a1 88 64 00 00       	mov    0x6488,%eax
     743:	52                   	push   %edx
  ...
  if(unlink("big") < 0){
    ...
    printf(stdout, "unlink big failed\n");
     786:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  printf(stdout, "big files ok\n");
     7a1:	a1 88 64 00 00       	mov    0x6488,%eax
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     7c0:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  name[0] = 'a';
     7d6:	c6 05 80 ac 00 00 61 	movb   $0x61,0xac80
  name[2] = '\0';
     7dd:	c6 05 82 ac 00 00 00 	movb   $0x0,0xac82
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     7f3:	a2 81 ac 00 00       	mov    %al,0xac81
    fd = open(name, O_CREATE|O_RDWR);
     7f8:	83 ec 08             	sub    $0x8,%esp
     7fb:	68 02 02 00 00       	push   $0x202
     800:	68 80 ac 00 00       	push   $0xac80
  ...
  name[0] = 'a';
     828:	c6 05 80 ac 00 00 61 	movb   $0x61,0xac80
  name[2] = '\0';
     82f:	c6 05 82 ac 00 00 00 	movb   $0x0,0xac82
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     845:	a2 81 ac 00 00       	mov    %al,0xac81
    unlink(name);
     84a:	83 ec 0c             	sub    $0xc,%esp
     84d:	68 80 ac 00 00       	push   $0xac80
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     864:	a1 88 64 00 00       	mov    0x6488,%eax
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     883:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(mkdir("dir0") < 0){
    ...
    printf(stdout, "mkdir failed\n");
     8ad:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(chdir("dir0") < 0){
    ...
    printf(stdout, "chdir dir0 failed\n");
     8dc:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(chdir("..") < 0){
    ...
    printf(stdout, "chdir .. failed\n");
     90b:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(unlink("dir0") < 0){
    ...
    printf(stdout, "unlink dir0 failed\n");
     93a:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  printf(stdout, "mkdir test ok\n");
     955:	a1 88 64 00 00       	mov    0x6488,%eax
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     974:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(exec("echo", echoargv) < 0){
     ...
     98d:	68 74 64 00 00       	push   $0x6474
    ...
    printf(stdout, "exec echo failed\n");
     9a3:	a1 88 64 00 00       	mov    0x6488,%eax
...
pipe1(void)
{
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a39:	05 80 8c 00 00       	add    $0x8c80,%eax
     ...
     a58:	68 80 8c 00 00       	push   $0x8c80
     a5d:	50                   	push   %eax
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ac8:	05 80 8c 00 00       	add    $0x8c80,%eax
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     b2b:	68 80 8c 00 00       	push   $0x8c80
     b30:	50                   	push   %eax
...
preempt(void)
{
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c66:	68 80 8c 00 00       	push   $0x8c80
     c6b:	50                   	push   %eax
...
fourfiles(void)
{
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1121:	50                   	push   %eax
    1122:	68 80 8c 00 00       	push   $0x8c80
    ...
    1140:	68 80 8c 00 00       	push   $0x8c80
  ...
  for(i = 0; i < 2; i++){
    ...
    11e9:	05 80 8c 00 00       	add    $0x8c80,%eax
    ...
    122f:	68 80 8c 00 00       	push   $0x8c80
...
unlinkread(void)
{
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    162c:	68 80 8c 00 00       	push   $0x8c80
  ...
  if(buf[0] != 'h'){
    1658:	0f b6 05 80 8c 00 00 	movzbl 0x8c80,%eax
  ...
  if(write(fd, buf, 10) != 10){
    ...
    167d:	6a 0a                	push   $0xa
    167f:	68 80 8c 00 00       	push   $0x8c80
...
linktest(void)
{
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1831:	68 80 8c 00 00       	push   $0x8c80
...
subdir(void)
{
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2111:	68 80 8c 00 00       	push   $0x8c80
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    212a:	0f b6 05 80 8c 00 00 	movzbl 0x8c80,%eax
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22c8:	68 80 8c 00 00       	push   $0x8c80
...
bigwrite(void)
{
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    273a:	68 80 8c 00 00       	push   $0x8c80
...
bigfile(void)
{
  ...
  for(i = 0; i < 20; i++){
    ...
    2831:	68 80 8c 00 00       	push   $0x8c80
    ...
    2846:	68 80 8c 00 00       	push   $0x8c80
  ...
  for(i = 0; ; i++){
    ...
    28d4:	68 80 8c 00 00       	push   $0x8c80
    ...
    292a:	0f b6 05 80 8c 00 00 	movzbl 0x8c80,%eax
    ...
    2944:	0f b6 05 ab 8d 00 00 	movzbl 0x8dab,%eax
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30fc:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  for(i = 0; i < 5000; i++){
    ...
    3153:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(pid < 0){
    ...
    31a1:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(c != a + 1){
    ...
    31e7:	a1 88 64 00 00       	mov    0x6488,%eax
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    324b:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    329c:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(c != a - 4096){
    ...
    32d4:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3338:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(*lastaddr == 99){
    ...
    3360:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(c != a){
    ...
    33b6:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33f1:	79 1b                	jns    340e <sbrktest+0x319>
      printf(stdout, "fork failed\n");
    33f3:	a1 88 64 00 00       	mov    0x6488,%eax
    ...
    341d:	a1 88 64 00 00       	mov    0x6488,%eax
    3422:	52                   	push   %edx
  ...
  if(c == (char*)0xffffffff){
    ...
    357b:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  printf(stdout, "sbrk test OK\n");
    35c8:	a1 88 64 00 00       	mov    0x6488,%eax
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    360d:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    369e:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  printf(stdout, "validate ok\n");
    36cc:	a1 88 64 00 00       	mov    0x6488,%eax
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    36eb:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  printf(stdout, "bss test ok\n");
    3742:	a1 88 64 00 00       	mov    0x6488,%eax
...
bigargtest(void)
{
  ...
  if(pid == 0){
    ...
    378f:	c7 04 85 c0 64 00 00 	movl   $0x5b34,0x64c0(,%eax,4)
    3796:	34 5b 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    args[MAXARG-1] = 0;
    37a4:	c7 05 3c 65 00 00 00 	movl   $0x0,0x653c
    37ab:	00 00 00 
    printf(stdout, "bigarg test\n");
    37ae:	a1 88 64 00 00       	mov    0x6488,%eax
    ...
    3820:	a1 88 64 00 00       	mov    0x6488,%eax
  ...
  if(fd < 0){
    ...
    385b:	a1 88 64 00 00       	mov    0x6488,%eax
...
fsfull()
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    39e0:	68 80 8c 00 00       	push   $0x8c80
...
uio()
{
  ...
  printf(1, "uio test\n");
    ...
    3b51:	68 ab 5c 00 00       	push   $0x5cab
    3b56:	6a 01                	push   $0x1
    3b58:	e8 1c 06 00 00       	call   4179 <printf>
  ...
  if(pid == 0){
    ...
    3b94:	68 b8 5c 00 00       	push   $0x5cb8
    3b99:	6a 01                	push   $0x1
    3b9b:	e8 d9 05 00 00       	call   4179 <printf>
    ...
    3bb1:	68 d1 45 00 00       	push   $0x45d1
    3bb6:	6a 01                	push   $0x1
    3bb8:	e8 bc 05 00 00       	call   4179 <printf>
  ...
  printf(1, "uio test done\n");
    ...
    3bcd:	68 d9 5c 00 00       	push   $0x5cd9
    3bd2:	6a 01                	push   $0x1
    3bd4:	e8 a0 05 00 00       	call   4179 <printf>
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3be8:	6a 00                	push   $0x0
    3bea:	68 e8 5c 00 00       	push   $0x5ce8
  ...
  if (fd < 0) {
    ...
    3c03:	68 ed 5c 00 00       	push   $0x5ced
    3c08:	6a 02                	push   $0x2
    3c0a:	e8 6a 05 00 00       	call   4179 <printf>
  ...
  printf(1, "arg test passed\n");
    ...
    3c49:	68 fa 5c 00 00       	push   $0x5cfa
    3c4e:	6a 01                	push   $0x1
    3c50:	e8 24 05 00 00       	call   4179 <printf>
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3c5e:	a1 8c 64 00 00       	mov    0x648c,%eax
    3c63:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3c69:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3c6e:	a3 8c 64 00 00       	mov    %eax,0x648c
  return randstate;
    3c73:	a1 8c 64 00 00       	mov    0x648c,%eax
}
    3c78:	5d                   	pop    %ebp
    3c79:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    ...
    3c8e:	68 0b 5d 00 00       	push   $0x5d0b
    3c93:	6a 01                	push   $0x1
    3c95:	e8 df 04 00 00       	call   4179 <printf>
    3c9a:	83 c4 10             	add    $0x10,%esp

  if(open("usertests.ran", 0) >= 0){
    3c9d:	83 ec 08             	sub    $0x8,%esp
    3ca0:	6a 00                	push   $0x0
    3ca2:	68 1f 5d 00 00       	push   $0x5d1f
    ...
    3cb6:	68 30 5d 00 00       	push   $0x5d30
    3cbb:	6a 01                	push   $0x1
    3cbd:	e8 b7 04 00 00       	call   4179 <printf>
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3cd2:	68 1f 5d 00 00       	push   $0x5d1f
...
00004096 <getpgtable>:
SYSCALL(getpgtable)
    4096:	b8 16 00 00 00       	mov    $0x16,%eax
    409b:	cd 40                	int    $0x40
    409d:	c3                   	ret    

0000409e <dump_rawphymem>:
    409e:	b8 17 00 00 00       	mov    $0x17,%eax
    40a3:	cd 40                	int    $0x40
    40a5:	c3                   	ret    
...
putc(int fd, char c)
{
    ...
    40af:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    40b2:	83 ec 04             	sub    $0x4,%esp
    40b5:	6a 01                	push   $0x1
    40b7:	8d 45 f4             	lea    -0xc(%ebp),%eax
    40ba:	50                   	push   %eax
    40bb:	ff 75 08             	pushl  0x8(%ebp)
    40be:	e8 53 ff ff ff       	call   4016 <write>
    40c3:	83 c4 10             	add    $0x10,%esp
}
    40c6:	90                   	nop
    40c7:	c9                   	leave  
    40c8:	c3                   	ret    
...
{
    40c9:	55                   	push   %ebp
    40ca:	89 e5                	mov    %esp,%ebp
    40cc:	83 ec 28             	sub    $0x28,%esp
  ...
  neg = 0;
    40cf:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    40d6:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    40da:	74 17                	je     40f3 <printint+0x2a>
    40dc:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    40e0:	79 11                	jns    40f3 <printint+0x2a>
    neg = 1;
    40e2:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    40e9:	8b 45 0c             	mov    0xc(%ebp),%eax
    40ec:	f7 d8                	neg    %eax
    40ee:	89 45 ec             	mov    %eax,-0x14(%ebp)
    40f1:	eb 06                	jmp    40f9 <printint+0x30>
  } else {
    x = xx;
    40f3:	8b 45 0c             	mov    0xc(%ebp),%eax
    40f6:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    40f9:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    4100:	8b 4d 10             	mov    0x10(%ebp),%ecx
    4103:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4106:	ba 00 00 00 00       	mov    $0x0,%edx
    410b:	f7 f1                	div    %ecx
    410d:	89 d1                	mov    %edx,%ecx
    410f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4112:	8d 50 01             	lea    0x1(%eax),%edx
    4115:	89 55 f4             	mov    %edx,-0xc(%ebp)
    4118:	0f b6 91 90 64 00 00 	movzbl 0x6490(%ecx),%edx
    411f:	88 54 05 dc          	mov    %dl,-0x24(%ebp,%eax,1)
  }while((x /= base) != 0);
    4123:	8b 4d 10             	mov    0x10(%ebp),%ecx
    4126:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4129:	ba 00 00 00 00       	mov    $0x0,%edx
    412e:	f7 f1                	div    %ecx
    4130:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4133:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4137:	75 c7                	jne    4100 <printint+0x37>
  if(neg)
    4139:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    413d:	74 2d                	je     416c <printint+0xa3>
    buf[i++] = '-';
    413f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4142:	8d 50 01             	lea    0x1(%eax),%edx
    4145:	89 55 f4             	mov    %edx,-0xc(%ebp)
    4148:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    414d:	eb 1d                	jmp    416c <printint+0xa3>
    putc(fd, buf[i]);
    414f:	8d 55 dc             	lea    -0x24(%ebp),%edx
    4152:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4155:	01 d0                	add    %edx,%eax
    4157:	0f b6 00             	movzbl (%eax),%eax
    415a:	0f be c0             	movsbl %al,%eax
    415d:	83 ec 08             	sub    $0x8,%esp
    4160:	50                   	push   %eax
    4161:	ff 75 08             	pushl  0x8(%ebp)
    4164:	e8 3d ff ff ff       	call   40a6 <putc>
    4169:	83 c4 10             	add    $0x10,%esp
  while(--i >= 0)
    416c:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    4170:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4174:	79 d9                	jns    414f <printint+0x86>
}
    4176:	90                   	nop
    4177:	c9                   	leave  
    4178:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    41d6:	e8 cb fe ff ff       	call   40a6 <putc>
    ...
    4200:	e8 c4 fe ff ff       	call   40c9 <printint>
    ...
    422a:	e8 9a fe ff ff       	call   40c9 <printint>
    ...
    4251:	75 25                	jne    4278 <printf+0xff>
          s = "(null)";
    4253:	c7 45 f4 5a 5d 00 00 	movl   $0x5d5a,-0xc(%ebp)
        while(*s != 0){
    ...
    426c:	e8 35 fe ff ff       	call   40a6 <putc>
    ...
    4299:	e8 08 fe ff ff       	call   40a6 <putc>
    ...
    42ba:	e8 e7 fd ff ff       	call   40a6 <putc>
    ...
    42cc:	e8 d5 fd ff ff       	call   40a6 <putc>
    ...
    42e1:	e8 c0 fd ff ff       	call   40a6 <putc>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    433a:	39 45 f8             	cmp    %eax,-0x8(%ebp)
    433d:	72 1a                	jb     4359 <free+0x4f>
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    4354:	39 45 f8             	cmp    %eax,-0x8(%ebp)
    4357:	73 ca                	jae    4323 <free+0x19>
      break;
  ...
  freep = p;
    ...
    43e4:	a3 48 65 00 00       	mov    %eax,0x6548
}
    43e9:	90                   	nop
    43ea:	c9                   	leave  
    43eb:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    440b:	50                   	push   %eax
    440c:	e8 6d fc ff ff       	call   407e <sbrk>
  ...
  return freep;
    4445:	a1 48 65 00 00       	mov    0x6548,%eax
}
    444a:	c9                   	leave  
    444b:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    4461:	a1 48 65 00 00       	mov    0x6548,%eax
    4466:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4469:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    446d:	75 23                	jne    4492 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    446f:	c7 45 f0 40 65 00 00 	movl   $0x6540,-0x10(%ebp)
    4476:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4479:	a3 48 65 00 00       	mov    %eax,0x6548
    447e:	a1 48 65 00 00       	mov    0x6548,%eax
    4483:	a3 40 65 00 00       	mov    %eax,0x6540
    base.s.size = 0;
    4488:	c7 05 44 65 00 00 00 	movl   $0x0,0x6544
    448f:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    44a0:	39 45 ec             	cmp    %eax,-0x14(%ebp)
    44a3:	77 4d                	ja     44f2 <malloc+0xa6>
      if(p->s.size == nunits)
    44a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44a8:	8b 40 04             	mov    0x4(%eax),%eax
    44ab:	39 45 ec             	cmp    %eax,-0x14(%ebp)
    ...
    44e5:	a3 48 65 00 00       	mov    %eax,0x6548
      return (void*)(p + 1);
    ...
    if(p == freep)
    44f2:	a1 48 65 00 00       	mov    0x6548,%eax
