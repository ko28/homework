...
\begin{enumerate}[label=\alph*.]
	...
	\item{
		  ...
		  \begin{proof}
			...
			$\textbf{Not sure if i need to show that T is a linear transformation}$\\
...
\begin{enumerate}[label=\alph*.]
	\item{
	      ...
	      \begin{proof}\ $\textbf{Pretty sure this is wrong}$ %TODO: FIX!!!
		      \begin{enumerate}[label=\roman*.]
			      \item{
			            Show $N_P = P(N_T)$\\\-\\
			            ...
			            \begin{align*}
				            ...
				            T^2(x)                      & = 0
			            \end{align*}
			            Thus $T(x) \in N_T$, so $x \in P(N_T$). So $N_p \subseteq P(N_T)$.\\\-\\
			            Let $x \in P(N_T)$. This means that $P(x) = 0$ because $P^2 = 0$.\\
			            So $x \in N_P$ and $ P(N_T)\subseteq N_P$ \\\-\\
			            Therfore, $N_P = P(N_T)$.
			            }
			      \item{
			            Show $N_T = T(N_P)$
	...
	\item{
	      ...
	      \begin{proof}\
		      ...
		      From (a), $dim(N_T) = m = dim(P(N_T)) \leq n$ and $dim(N_P) = n = dim(T(N_P)) \leq m$\\
			 %FIX 
			  \[\textbf{ not sure if $dim(P(N_T)) \leq n$ holds}\]
		      Hence, $n = m$. Therefore, $dim(V)$ is even.
	      \end{proof}
	      }
	\item{
