...
printint(int fd, int xx, int base, int sgn)
{
 ...
 409:	0f b6 91 9c 0a 00 00 	movzbl 0xa9c(%ecx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 542:	75 25                	jne    569 <printf+0xff>
          s = "(null)";
 544:	c7 45 f4 4d 08 00 00 	movl   $0x84d,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 60a:	a1 b8 0a 00 00       	mov    0xab8,%eax
 ...
 6d5:	a3 b8 0a 00 00       	mov    %eax,0xab8
}
 6da:	90                   	nop
 6db:	c9                   	leave  
 6dc:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 733:	83 c4 10             	add    $0x10,%esp
  return freep;
 736:	a1 b8 0a 00 00       	mov    0xab8,%eax
}
 73b:	c9                   	leave  
 73c:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 74f:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 752:	a1 b8 0a 00 00       	mov    0xab8,%eax
 757:	89 45 f0             	mov    %eax,-0x10(%ebp)
 75a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 75e:	75 23                	jne    783 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 760:	c7 45 f0 b0 0a 00 00 	movl   $0xab0,-0x10(%ebp)
 767:	8b 45 f0             	mov    -0x10(%ebp),%eax
 76a:	a3 b8 0a 00 00       	mov    %eax,0xab8
 76f:	a1 b8 0a 00 00       	mov    0xab8,%eax
 774:	a3 b0 0a 00 00       	mov    %eax,0xab0
    base.s.size = 0;
 779:	c7 05 b4 0a 00 00 00 	movl   $0x0,0xab4
 780:	00 00 00 
  }
 ...
 7d6:	a3 b8 0a 00 00       	mov    %eax,0xab8
      return (void*)(p + 1);
 ...
 7e1:	eb 3b                	jmp    81e <malloc+0xe1>
    ...
    if(p == freep)
 7e3:	a1 b8 0a 00 00       	mov    0xab8,%eax
