...
printint(int fd, int xx, int base, int sgn)
{
 ...
 314:	0f b6 92 44 06 00 00 	movzbl 0x644(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 450:	75 28                	jne    47a <printf+0x12a>
          s = "(null)";
 452:	be 3b 06 00 00       	mov    $0x63b,%esi
...
free(void *ap)
{
 ...
 4c5:	a1 e8 08 00 00       	mov    0x8e8,%eax
 ...
 501:	89 08                	mov    %ecx,(%eax)
  freep = p;
 503:	a3 e8 08 00 00       	mov    %eax,0x8e8
}
 508:	5b                   	pop    %ebx
 509:	5e                   	pop    %esi
 50a:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 560:	e8 54 ff ff ff       	call   4b9 <free>
  return freep;
 565:	a1 e8 08 00 00       	mov    0x8e8,%eax
...
malloc(uint nbytes)
{
 ...
 589:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 58c:	8b 0d e8 08 00 00    	mov    0x8e8,%ecx
 ...
 598:	eb 4d                	jmp    5e7 <malloc+0x6e>
    base.s.ptr = freep = prevp = &base;
 59a:	c7 05 e8 08 00 00 ec 	movl   $0x8ec,0x8e8
 5a1:	08 00 00 
 5a4:	c7 05 ec 08 00 00 ec 	movl   $0x8ec,0x8ec
 5ab:	08 00 00 
    base.s.size = 0;
 5ae:	c7 05 f0 08 00 00 00 	movl   $0x0,0x8f0
 5b5:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 5b8:	b9 ec 08 00 00       	mov    $0x8ec,%ecx
 ...
 5cb:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 5ce:	89 0d e8 08 00 00    	mov    %ecx,0x8e8
      return (void*)(p + 1);
 ...
 5ec:	73 d1                	jae    5bf <malloc+0x46>
    if(p == freep)
 5ee:	39 05 e8 08 00 00    	cmp    %eax,0x8e8
